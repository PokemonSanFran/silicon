...
#define B_VAR_NO_BAG_USE         VAR_NO_BAG_USE     // If set to 1, the ability to use the Bag is disabled in Trainer battles. If set to 2, it is also disabled in wild battles.
