...
extern const u32 gItemIcon_ArbolivaOil[];
extern const u16 gItemIconPalette_ArbolivaOil[];
extern const u32 gItemIcon_BigAirBalloon[];
extern const u16 gItemIconPalette_BigAirBalloon[];
extern const u32 gItemIcon_BlueskyMail[];
extern const u16 gItemIconPalette_BlueskyMail[];
extern const u32 gItemIcon_BodegaDelivery1[];
extern const u16 gItemIconPalette_BodegaDelivery1[];
extern const u32 gItemIcon_BodegaDelivery3[];
extern const u16 gItemIconPalette_BodegaDelivery3[];
extern const u32 gItemIcon_BodegaDelivery4[];
extern const u16 gItemIconPalette_BodegaDelivery4[];
extern const u32 gItemIcon_BodegaDelivery5[];
extern const u16 gItemIconPalette_BodegaDelivery5[];
extern const u32 gItemIcon_BodegaDelivery6[];
extern const u16 gItemIconPalette_BodegaDelivery6[];
extern const u32 gItemIcon_BodegaDelivery7[];
extern const u16 gItemIconPalette_BodegaDelivery7[];
extern const u32 gItemIcon_BodegaDelivery8[];
extern const u16 gItemIconPalette_BodegaDelivery8[];
extern const u32 gItemIcon_BodegaDelivery9[];
extern const u16 gItemIconPalette_BodegaDelivery9[];
extern const u32 gItemIcon_BodegaDelivery10[];
extern const u16 gItemIconPalette_BodegaDelivery10[];
extern const u32 gItemIcon_BodegaDelivery2[];
extern const u16 gItemIconPalette_BodegaDelivery2[];
extern const u32 gItemIcon_BookSigningMerch[];
extern const u16 gItemIconPalette_BookSigningMerch[];
extern const u32 gItemIcon_BoxOfDisaster[];
extern const u16 gItemIconPalette_BoxOfDisaster[];
extern const u32 gItemIcon_BucketOfLentils[];
extern const u16 gItemIconPalette_BucketOfLentils[];
extern const u32 gItemIcon_CellPhone[];
extern const u16 gItemIconPalette_CellPhone[];
extern const u32 gItemIcon_Centiskorchinite[];
extern const u16 gItemIconPalette_Centiskorchinite[];
extern const u32 gItemIcon_Che[];
extern const u16 gItemIconPalette_Che[];
extern const u32 gItemIcon_Chebureki[];
extern const u16 gItemIconPalette_Chebureki[];
extern const u32 gItemIcon_ChillOutCone[];
extern const u16 gItemIconPalette_ChillOutCone[];
extern const u32 gItemIcon_ChronicCrepe[];
extern const u16 gItemIconPalette_ChronicCrepe[];
extern const u32 gItemIcon_Copperajite[];
extern const u16 gItemIconPalette_Copperajite[];
extern const u32 gItemIcon_Corviknite[];
extern const u16 gItemIconPalette_Corviknite[];
extern const u32 gItemIcon_Drednawite[];
extern const u16 gItemIconPalette_Drednawite[];
extern const u32 gItemIcon_DropsInTheOcean[];
extern const u16 gItemIconPalette_DropsInTheOcean[];
extern const u32 gItemIcon_Duraludonite[];
extern const u16 gItemIconPalette_Duraludonite[];
extern const u32 gItemIcon_EggTicket[];
extern const u16 gItemIconPalette_EggTicket[];
extern const u32 gItemIcon_FamiliarBell[];
extern const u16 gItemIconPalette_FamiliarBell[];
extern const u32 gItemIcon_FieryTorch[];
extern const u16 gItemIconPalette_FieryTorch[];
extern const u32 gItemIcon_FirstAidKit[];
extern const u16 gItemIconPalette_FirstAidKit[];
extern const u32 gItemIcon_Garbodorite[];
extern const u16 gItemIconPalette_Garbodorite[];
extern const u32 gItemIcon_GoldPotion[];
extern const u16 gItemIconPalette_GoldPotion[];
extern const u32 gItemIcon_GreenMahjongTile[];
extern const u16 gItemIconPalette_GreenMahjongTile[];
extern const u32 gItemIcon_Hatterenite[];
extern const u16 gItemIconPalette_Hatterenite[];
extern const u32 gItemIcon_HyperAroma[];
extern const u16 gItemIconPalette_HyperAroma[];
extern const u32 gItemIcon_Jeans[];
extern const u16 gItemIconPalette_Jeans[];
extern const u32 gItemIcon_Jianbing[];
extern const u16 gItemIconPalette_Jianbing[];
extern const u32 gItemIcon_JournalPage1[];
extern const u16 gItemIconPalette_JournalPage1[];
extern const u32 gItemIcon_JournalPage2[];
extern const u16 gItemIconPalette_JournalPage2[];
extern const u32 gItemIcon_JournalPage3[];
extern const u16 gItemIconPalette_JournalPage3[];
extern const u32 gItemIcon_Karioka[];
extern const u16 gItemIconPalette_Karioka[];
...
extern const u32 gItemIcon_LostDoll[];
extern const u16 gItemIconPalette_LostDoll[];
extern const u32 gItemIcon_MaximumBelt[];
extern const u16 gItemIconPalette_MaximumBelt[];
extern const u32 gItemIcon_NatureProbe[];
extern const u16 gItemIconPalette_NatureProbe[];
extern const u32 gItemIcon_Orbeetleite[];
extern const u16 gItemIconPalette_Orbeetleite[];
extern const u32 gItemIcon_Pasta[];
extern const u16 gItemIconPalette_Pasta[];
extern const u32 gItemIcon_PlumMahjongTile[];
extern const u16 gItemIconPalette_PlumMahjongTile[];
extern const u32 gItemIcon_PuffPuffPastry[];
extern const u16 gItemIconPalette_PuffPuffPastry[];
extern const u32 gItemIcon_RangerHeadphones[];
extern const u16 gItemIconPalette_RangerHeadphones[];
extern const u32 gItemIcon_Sandaconite[];
extern const u16 gItemIconPalette_Sandaconite[];
extern const u32 gItemIcon_SeasoningMix[];
extern const u16 gItemIconPalette_SeasoningMix[];
extern const u32 gItemIcon_SherbetSurprise[];
...
extern const u16 gItemIconPalette_SpikedConcha[];
extern const u32 gItemIcon_SummerMahjongTile[];
extern const u16 gItemIconPalette_SummerMahjongTile[];
extern const u32 gItemIcon_Tahini[];
extern const u16 gItemIconPalette_Tahini[];
extern const u32 gItemIcon_UrshifuiteRapid[];
extern const u16 gItemIconPalette_UrshifuiteRapid[];
extern const u32 gItemIcon_UrshifuiteSingle[];
extern const u16 gItemIconPalette_UrshifuiteSingle[];
extern const u32 gItemIcon_UturnBoard[];
extern const u16 gItemIconPalette_UturnBoard[];
extern const u32 gItemIcon_WindupArm[];
extern const u16 gItemIconPalette_WindupArm[];
// End siliconQuests
