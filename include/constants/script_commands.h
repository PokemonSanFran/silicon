...
#define SCR_OP_VARIABLEADDMONEY 0xf9
#define SCR_OP_VARIABLEREMOVEMONEY 0xfa
#define SCR_OP_VARIABLECHECKMONEY 0xfb
#define SCR_OP_HIDEFOLLOWER 0xfc
#define SCR_OP_SETOBJECTFLAGFROMLOCALID 0xfd
#define SCR_OP_CLEAROBJECTFLAGFROMLOCALID 0xfe
