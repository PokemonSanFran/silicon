...
#define ITEM_TM401 982
#define ITEM_TM402 983
#define ITEM_TM403 984
#define ITEM_TM404 985
#define ITEM_TM405 986
#define ITEM_TM406 987
#define ITEM_TM407 988
#define ITEM_TM408 989
#define ITEM_TM409 990
#define ITEM_TM410 991
#define ITEM_TM411 992
#define ITEM_TM412 993
#define ITEM_TM413 994
#define ITEM_TM414 995
#define ITEM_TM415 996
#define ITEM_TM416 997
#define ITEM_TM417 998
#define ITEM_TM418 999
#define ITEM_TM419 1000
#define ITEM_TM420 1001
#define ITEM_TM421 1002
#define ITEM_TM422 1003
#define ITEM_TM423 1004
#define ITEM_TM424 1005
#define ITEM_TM425 1006
#define ITEM_TM426 1007
#define ITEM_TM427 1008
#define ITEM_TM428 1009
#define ITEM_TM429 1010
#define ITEM_TM430 1011
#define ITEM_TM431 1012
#define ITEM_TM432 1013
#define ITEM_TM433 1014
#define ITEM_TM434 1015
#define ITEM_TM435 1016
#define ITEM_TM436 1017

#define FIRST_TM_INDEX ITEM_TM01
#define LAST_TM_INDEX ITEM_TM436

#define ITEM_HM01 1018
#define ITEM_HM02 1019
#define ITEM_HM03 1020
#define ITEM_HM04 1021
#define ITEM_HM05 1022
#define ITEM_HM06 1023
#define ITEM_HM07 1024
#define ITEM_HM08 1025

// Charms
#define ITEM_OVAL_CHARM 1026
#define ITEM_SHINY_CHARM 1027
#define ITEM_CATCHING_CHARM 1028
#define ITEM_EXP_CHARM 1029

// Form-changing Key Items
#define ITEM_ROTOM_CATALOG 1030
#define ITEM_GRACIDEA 1031
#define ITEM_REVEAL_GLASS 1032
#define ITEM_DNA_SPLICERS 1033
#define ITEM_ZYGARDE_CUBE 1034
#define ITEM_PRISON_BOTTLE 1035
#define ITEM_N_SOLARIZER 1036
#define ITEM_N_LUNARIZER 1037
#define ITEM_REINS_OF_UNITY 1038

// Battle Mechanic Key Items
#define ITEM_MEGA_RING 1039
#define ITEM_Z_POWER_RING 1040
#define ITEM_DYNAMAX_BAND 1041

// Misc. Key Items
#define ITEM_BICYCLE 1042
#define ITEM_MACH_BIKE 1043
#define ITEM_ACRO_BIKE 1044
#define ITEM_OLD_ROD 1045
#define ITEM_GOOD_ROD 1046
#define ITEM_SUPER_ROD 1047
#define ITEM_FISHING_ROD ITEM_SUPER_ROD // wildEncounters
#define ITEM_DOWSING_MACHINE 1048
#define ITEM_ITEMFINDER ITEM_DOWSING_MACHINE // Pre-Gen IV name
#define ITEM_DOWSING_MCHN ITEM_DOWSING_MACHINE // Gen IV-V name
#define ITEM_TOWN_MAP 1049
#define ITEM_VS_SEEKER 1050
#define ITEM_TM_CASE 1051
#define ITEM_BERRY_POUCH 1052
#define ITEM_POKEMON_BOX_LINK 1053
#define ITEM_POKEMON_BOX ITEM_POKEMON_BOX_LINK // Pre-Gen VIII name
#define ITEM_COIN_CASE 1054
#define ITEM_POWDER_JAR 1055
#define ITEM_WAILMER_PAIL 1056
#define ITEM_POKE_RADAR 1057
#define ITEM_POKEBLOCK_CASE 1058
#define ITEM_SOOT_SACK 1059
#define ITEM_POKE_FLUTE 1060
#define ITEM_FAME_CHECKER 1061
#define ITEM_TEACHY_TV 1062

// Story Key Items
#define ITEM_SS_TICKET 1063
#define ITEM_EON_TICKET 1064
#define ITEM_MYSTIC_TICKET 1065
#define ITEM_AURORA_TICKET 1066
#define ITEM_OLD_SEA_MAP 1067
#define ITEM_LETTER 1068
#define ITEM_DEVON_PARTS 1069
#define ITEM_DEVON_GOODS ITEM_DEVON_PARTS // Pre-Gen VI name
#define ITEM_GO_GOGGLES 1070
#define ITEM_DEVON_SCOPE 1071
#define ITEM_BASEMENT_KEY 1072
#define ITEM_SCANNER 1073
#define ITEM_STORAGE_KEY 1074
#define ITEM_KEY_TO_ROOM_1 1075
#define ITEM_RM_1_KEY ITEM_KEY_TO_ROOM_1 // Pre-Gen VI name
#define ITEM_KEY_TO_ROOM_2 1076
#define ITEM_RM_2_KEY ITEM_KEY_TO_ROOM_2 // Pre-Gen VI name
#define ITEM_KEY_TO_ROOM_4 1077
#define ITEM_RM_4_KEY ITEM_KEY_TO_ROOM_4 // Pre-Gen VI name
#define ITEM_KEY_TO_ROOM_6 1078
#define ITEM_RM_6_KEY ITEM_KEY_TO_ROOM_6 // Pre-Gen VI name
#define ITEM_METEORITE 1079
#define ITEM_MAGMA_EMBLEM 1080
#define ITEM_CONTEST_PASS 1081
#define ITEM_PARCEL 1082
#define ITEM_OAKS_PARCEL ITEM_PARCEL // Pre-Gen IV name
#define ITEM_SECRET_KEY 1083
#define ITEM_BIKE_VOUCHER 1084
#define ITEM_GOLD_TEETH 1085
#define ITEM_CARD_KEY 1086
#define ITEM_LIFT_KEY 1087
#define ITEM_SILPH_SCOPE 1088
#define ITEM_TRI_PASS 1089
#define ITEM_RAINBOW_PASS 1090
#define ITEM_TEA 1091
#define ITEM_RUBY 1092
#define ITEM_SAPPHIRE 1093

// GEN IX ITEMS
#define ITEM_ABILITY_SHIELD 1094
#define ITEM_CLEAR_AMULET 1095
#define ITEM_PUNCHING_GLOVE 1096
#define ITEM_COVERT_CLOAK 1097
#define ITEM_LOADED_DICE 1098
#define ITEM_AUSPICIOUS_ARMOR 1099
#define ITEM_BOOSTER_ENERGY 1100
#define ITEM_BIG_BAMBOO_SHOOT 1101
#define ITEM_GIMMIGHOUL_COIN 1102
#define ITEM_LEADERS_CREST 1103
#define ITEM_MALICIOUS_ARMOR 1104
#define ITEM_MIRROR_HERB 1105
#define ITEM_SCROLL_OF_DARKNESS 1106
#define ITEM_SCROLL_OF_WATERS 1107
#define ITEM_TERA_ORB 1108
#define ITEM_TINY_BAMBOO_SHOOT 1109

#define ITEM_BUG_TERA_SHARD 1110
#define ITEM_DARK_TERA_SHARD 1111
#define ITEM_DRAGON_TERA_SHARD 1112
#define ITEM_ELECTRIC_TERA_SHARD 1113
#define ITEM_FAIRY_TERA_SHARD 1114
#define ITEM_FIGHTING_TERA_SHARD 1115
#define ITEM_FIRE_TERA_SHARD 1116
#define ITEM_FLYING_TERA_SHARD 1117
#define ITEM_GHOST_TERA_SHARD 1118
#define ITEM_GRASS_TERA_SHARD 1119
#define ITEM_GROUND_TERA_SHARD 1120
#define ITEM_ICE_TERA_SHARD 1121
#define ITEM_NORMAL_TERA_SHARD 1122
#define ITEM_POISON_TERA_SHARD 1123
#define ITEM_PSYCHIC_TERA_SHARD 1124
#define ITEM_ROCK_TERA_SHARD 1125
#define ITEM_STEEL_TERA_SHARD 1126
#define ITEM_WATER_TERA_SHARD 1127

#define ITEM_ADAMANT_CRYSTAL 1128
#define ITEM_GRISEOUS_CORE 1129
#define ITEM_LUSTROUS_GLOBE 1130

#define ITEM_BLACK_AUGURITE 1131
#define ITEM_LINKING_CORD 1132
#define ITEM_PEAT_BLOCK 1133
#define ITEM_BERSERK_GENE 1134
// Silicon Items
#define ITEM_HEXORB 1135
#define ITEM_BOX_OF_DISASTER ITEM_HEXORB
#define ITEM_LOST_DOLL 1136
#define ITEM_SHERBET_SURPRISE 1137

#define ITEM_PANTRY_A 1138
#define ITEM_PANTRY_B 1139
#define ITEM_PANTRY_C 1140
#define ITEM_PANTRY_D 1141
#define ITEM_PANTRY_E 1142
#define ITEM_PANTRY_START ITEM_PANTRY_A
#define ITEM_PANTRY_END   ITEM_PANTRY_E

#define ITEM_PANNEN_JOURNAL_PAGE_1 1143
#define ITEM_PANNEN_JOURNAL_PAGE_2 1144
#define ITEM_PANNEN_JOURNAL_PAGE_3 1145
#define ITEM_BODEGA_DELIVERY_1 1146
#define ITEM_BODEGA_DELIVERY_2 1147
#define ITEM_BODEGA_DELIVERY_3 1148
#define ITEM_BODEGA_DELIVERY_4 1149
#define ITEM_BODEGA_DELIVERY_5 1150
#define ITEM_BODEGA_DELIVERY_6 1151
#define ITEM_BODEGA_DELIVERY_7 1152
#define ITEM_BODEGA_DELIVERY_8 1153
#define ITEM_BODEGA_DELIVERY_9 1154
#define ITEM_BODEGA_DELIVERY_10 1155
#define ITEM_POKEVIAL 1156

//Start qol_field_moves
#define ITEM_CUT_TOOL 1157
#define ITEM_FLY_TOOL 1158
#define ITEM_SURF_TOOL 1159
#define ITEM_STRENGTH_TOOL 1160
#define ITEM_FLASH_TOOL 1161
#define ITEM_ROCKSMASH_TOOL 1162
#define ITEM_WATERFALL_TOOL 1163
#define ITEM_DIVE_TOOL 1164
#define ITEM_TELEPORT_TOOL 1165
#define ITEM_SWEETSCENT_TOOL 1166
//End qol_field_moves

#define ITEM_WISH_TAG ITEM_METEORITE

#define ITEM_FAIRY_FEATHER 1167
#define ITEM_SYRUPY_APPLE 1168
#define ITEM_UNREMARKABLE_TEACUP 1169
#define ITEM_MASTERPIECE_TEACUP 1170
#define ITEM_CORNERSTONE_MASK 1171
#define ITEM_WELLSPRING_MASK 1172
#define ITEM_HEARTHFLAME_MASK 1173
#define ITEM_HEALTH_MOCHI 1174
#define ITEM_MUSCLE_MOCHI 1175
#define ITEM_RESIST_MOCHI 1176
#define ITEM_GENIUS_MOCHI 1177
#define ITEM_CLEVER_MOCHI 1178
#define ITEM_SWIFT_MOCHI 1179
#define ITEM_FRESH_START_MOCHI 1180
#define ITEM_GLIMMERING_CHARM 1181
#define ITEM_INFINITE_SPRAY 1182

#define ITEM_METAL_ALLOY 1183
#define ITEM_STELLAR_TERA_SHARD 1184
#define ITEM_JUBILIFE_MUFFIN 1185
#define ITEM_REMEDY 1186
#define ITEM_FINE_REMEDY 1187
#define ITEM_SUPERB_REMEDY 1188
#define ITEM_AUX_EVASION 1189
#define ITEM_AUX_GUARD 1190
#define ITEM_AUX_POWER 1191
#define ITEM_AUX_POWERGUARD 1192
#define ITEM_CHOICE_DUMPLING 1193
#define ITEM_SWAP_SNACK 1194
#define ITEM_TWICE_SPICED_RADISH 1195
#define ITEM_POKESHI_DOLL 1196
#define ITEM_KINGLERNITE 1197
#define ITEM_LAPRASNITE 1198
#define ITEM_GARBODORNITE 1199
#define ITEM_CORVIKNIGHTNITE 1200
#define ITEM_ORBEETLENITE 1201
#define ITEM_DREDNAWNITE 1202
#define ITEM_SANDACONDANITE 1203
#define ITEM_CENTISKORCHNITE 1204
#define ITEM_HATTERENENITE 1205
#define ITEM_COPPERAJAHNITE 1206
#define ITEM_DURALUDONNITE 1207
#define ITEM_URSHIFUNITE_SINGLE 1208
#define ITEM_URSHIFUNITE_RAPID 1209
#define ITEM_STRANGE_BALL 1210

// Start siliconNewBalls
#define ITEM_NEWA_BALL 1211
#define ITEM_NEWB_BALL 1212
#define ITEM_NEWC_BALL 1213
#define ITEM_NEWD_BALL 1214
#define ITEM_NEWE_BALL 1215
#define ITEM_NEWF_BALL 1216
#define ITEM_NEWG_BALL 1217
#define ITEM_NEWH_BALL 1218
// End siliconNewBalls

#define ITEM_CLEFABLITE 1219
#define ITEM_VICTREEBELITE 1220
#define ITEM_STARMINITE 1221
#define ITEM_DRAGONINITE 1222
#define ITEM_MEGANIUMITE 1223
#define ITEM_FERALIGITE 1224
#define ITEM_SKARMORITE 1225
#define ITEM_FROSLASSITE 1226
#define ITEM_EMBOARITE 1227
#define ITEM_EXCADRITE 1228
#define ITEM_SCOLIPITE 1229
#define ITEM_SCRAFTINITE 1230
#define ITEM_EELEKTROSSITE 1231
#define ITEM_CHANDELURITE 1232
#define ITEM_CHESNAUGHTITE 1233
#define ITEM_DELPHOXITE 1234
#define ITEM_GRENINJITE 1235
#define ITEM_PYROARITE 1236
#define ITEM_FLOETTITE 1237
#define ITEM_MALAMARITE 1238
#define ITEM_BARBARACITE 1239
#define ITEM_DRAGALGITE 1240
#define ITEM_HAWLUCHANITE 1241
