...
// Start pointsMessage
    STRINGID_BATTLERFAINTED_NOBREAK,
// End pointsMessage
    ...
    STRINGID_TAKEWILDMONITEM,
    STRINGID_OBTAINEDITEM,
    STRINGID_PLAYERRECEIVEDNATIVEITEM,
// Start Battle Settings: Nickname
    STRINGID_LETSGIVEITANICKNAME,
    STRINGID_POKEMONMUSTHAVEANICKNAME,
// End Battle Settings: Nickname
    STRINGID_PKMNGAINEDPOINTS,
    STRINGID_PKMNGAINEDEVS,
    STRINGID_STORAGEGAINEDPOINTS,
    STRINGID_ALLGAINEDEXP,
    STRINGID_PARTYGAINEDEXP,
    STRINGID_STORAGEGAINEDEXP,
    STRINGID_ALLGAINEDEVS,
    STRINGID_PARTYGAINEDEVS,
    STRINGID_STORAGEGAINEDEVS,
    STRINGID_PARTYGAINEDPOINTS,
    STRINGID_ALLGAINEDPOINTS,
    ...
    STRINGID_FONT_CHECK, // silicon-specific-tests
    STRINGID_COUNT
};
