...
enum
{
    ...
    OBJ_EVENT_GFX_CHARLOTTE,
    OBJ_EVENT_GFX_CHARLOTTE_FIELD_MOVE,
    OBJ_EVENT_GFX_TRACHY,
...
enum
{
  ...
  OBJ_EVENT_PAL_TAG_PRODUCT_MANAGER_2,
    OBJ_EVENT_PAL_TAG_CHARLOTTE,
    OBJ_EVENT_PAL_TAG_TRACHY,
    OBJ_EVENT_PAL_TAG_SHINJI,
};
  // End silicon
