...
enum  
{
  OBJ_EVENT_PAL_TAG_BALL_VITALITY = OBJ_EVENT_PAL_TAG_BALL_STRANGE + 1,
  OBJ_EVENT_PAL_TAG_BALL_PSYCHE,            
  OBJ_EVENT_PAL_TAG_BALL_MINERAL,          
  OBJ_EVENT_PAL_TAG_BALL_ELECTRO,
  OBJ_EVENT_PAL_TAG_BALL_BOG,  
  OBJ_EVENT_PAL_TAG_BALL_JETSTREAM, 
  OBJ_EVENT_PAL_TAG_BALL_FABLE,
  OBJ_EVENT_PAL_TAG_BALL_PARADOX,
};
// End siliconNewBalls
