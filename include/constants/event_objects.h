...
enum
{
    OBJ_EVENT_GFX_KAI = OBJ_EVENT_GFX_BREAKABLE_ROCK_FRLG + 1,
    ...
    OBJ_EVENT_GFX_KAI_FAINTED,
    OBJ_EVENT_GFX_ADAORA_FAINTED,
    OBJ_EVENT_GFX_KAI_FIELD_MOVE,
    OBJ_EVENT_GFX_KAUNA_SURFING,
    ...
    OBJ_EVENT_GFX_ADELAIDE = OBJ_EVENT_GFX_MAXIE,
    OBJ_EVENT_GFX_ARMANDO = OBJ_EVENT_GFX_GLACIA,
    OBJ_EVENT_GFX_CHARLOTTE = OBJ_EVENT_GFX_MAY_NORMAL,
    OBJ_EVENT_GFX_ELLEN = OBJ_EVENT_GFX_DRAKE,
...
enum
{
  OBJ_EVENT_PAL_TAG_KAI = OBJ_EVENT_PAL_TAG_SS_ANNE + 1,
  OBJ_EVENT_PAL_TAG_UNKNOWN,
  OBJ_EVENT_PAL_TAG_ADAORA,
  OBJ_EVENT_PAL_TAG_ALCMENE,
