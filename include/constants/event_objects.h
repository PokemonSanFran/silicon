...
enum
{
    OBJ_EVENT_GFX_BAIYA = OBJ_EVENT_GFX_BREAKABLE_ROCK_FRLG + 1,
    OBJ_EVENT_GFX_UNKNOWN,
    OBJ_EVENT_GFX_ADAORA,
    OBJ_EVENT_GFX_VIGRIM,
    OBJ_EVENT_GFX_BD,
    OBJ_EVENT_GFX_BELEN,
    OBJ_EVENT_GFX_DIMU,
    OBJ_EVENT_GFX_DOYLE,
    OBJ_EVENT_GFX_EMRYS,
    OBJ_EVENT_GFX_IMELDA,
    OBJ_EVENT_GFX_PUA,
    OBJ_EVENT_GFX_KEIYING,
    OBJ_EVENT_GFX_MAGNUS,
    OBJ_EVENT_GFX_NERIENE,
    OBJ_EVENT_GFX_SHINZO,
    OBJ_EVENT_GFX_BAIYA_FAINTED,
    OBJ_EVENT_GFX_ADAORA_FAINTED,
    OBJ_EVENT_GFX_BAIYA_FIELD_MOVE,
    OBJ_EVENT_GFX_PUA_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_F1_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_F1_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_F1_ACRO_BIKE,
    ...
    OBJ_EVENT_GFX_SILICON_PLAYER_F3_ACRO_BIKE,
    ...
    OBJ_EVENT_GFX_SILICON_PLAYER_F2_ACRO_BIKE,
    ...
    OBJ_EVENT_GFX_SILICON_PLAYER_N3_ACRO_BIKE,
    ...
    OBJ_EVENT_GFX_COMRADE_1,
    OBJ_EVENT_GFX_COMRADE_2,
    OBJ_EVENT_GFX_COMRADE_3,
    OBJ_EVENT_GFX_COMRADE_4,
    OBJ_EVENT_GFX_COMRADE_5,
    OBJ_EVENT_GFX_COMRADE_6,
    OBJ_EVENT_GFX_COMRADE_7,
    OBJ_EVENT_GFX_COMRADE_8,
    OBJ_EVENT_GFX_COMRADE_9,
    OBJ_EVENT_GFX_DESIGNER_1,
    OBJ_EVENT_GFX_DESIGNER_2,
    OBJ_EVENT_GFX_DEVELOPER_1,
    OBJ_EVENT_GFX_DEVELOPER_2,
    OBJ_EVENT_GFX_FOUNDER_1,
    OBJ_EVENT_GFX_FOUNDER_2,
    OBJ_EVENT_GFX_PRODUCT_MANAGER_1,
    OBJ_EVENT_GFX_PRODUCT_MANAGER_2,
    NUM_OBJ_EVENT_GFX,
    //PSF TODO move these up once they are created
    OBJ_EVENT_GFX_LUCREZIA = OBJ_EVENT_GFX_MAXIE,
    OBJ_EVENT_GFX_FRANK = OBJ_EVENT_GFX_GLACIA,
    OBJ_EVENT_GFX_CHARLOTTE = OBJ_EVENT_GFX_MAY_NORMAL,
    OBJ_EVENT_GFX_ELEANOR = OBJ_EVENT_GFX_DRAKE,
    OBJ_EVENT_GFX_OLIVER = OBJ_EVENT_GFX_PROF_BIRCH,
    OBJ_EVENT_GFX_RAMESH = OBJ_EVENT_GFX_MAGMA_MEMBER_M,
    OBJ_EVENT_GFX_AMIARGENTO = OBJ_EVENT_GFX_JUAN,
    OBJ_EVENT_GFX_TALA = OBJ_EVENT_GFX_SIDNEY,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_FIELD_MOVE = OBJ_EVENT_GFX_SILICON_PLAYER_F1_FIELD_MOVE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_FISHING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_FISHING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_MACH_BIKE = OBJ_EVENT_GFX_SILICON_PLAYER_F1_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_NORMAL = OBJ_EVENT_GFX_SILICON_PLAYER_F1_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_SURFING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_UNDERWATER = OBJ_EVENT_GFX_SILICON_PLAYER_F1_UNDERWATER,
    OBJ_EVENT_GFX_SILICON_PLAYER_M1_WATERING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_WATERING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_FIELD_MOVE = OBJ_EVENT_GFX_SILICON_PLAYER_F2_FIELD_MOVE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_FISHING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_FISHING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_MACH_BIKE = OBJ_EVENT_GFX_SILICON_PLAYER_F2_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_NORMAL = OBJ_EVENT_GFX_SILICON_PLAYER_F2_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_SURFING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_UNDERWATER = OBJ_EVENT_GFX_SILICON_PLAYER_F2_UNDERWATER,
    OBJ_EVENT_GFX_SILICON_PLAYER_M2_WATERING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_WATERING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_FIELD_MOVE = OBJ_EVENT_GFX_SILICON_PLAYER_F3_FIELD_MOVE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_FISHING = OBJ_EVENT_GFX_SILICON_PLAYER_F3_FISHING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_MACH_BIKE = OBJ_EVENT_GFX_SILICON_PLAYER_F3_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_NORMAL = OBJ_EVENT_GFX_SILICON_PLAYER_F3_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_SURFING = OBJ_EVENT_GFX_SILICON_PLAYER_F3_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_UNDERWATER = OBJ_EVENT_GFX_SILICON_PLAYER_F3_UNDERWATER,
    OBJ_EVENT_GFX_SILICON_PLAYER_M3_WATERING = OBJ_EVENT_GFX_SILICON_PLAYER_F3_WATERING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_FIELD_MOVE = OBJ_EVENT_GFX_SILICON_PLAYER_F1_FIELD_MOVE,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_FISHING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_FISHING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_MACH_BIKE = OBJ_EVENT_GFX_SILICON_PLAYER_F1_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_NORMAL = OBJ_EVENT_GFX_SILICON_PLAYER_F1_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_SURFING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_UNDERWATER = OBJ_EVENT_GFX_SILICON_PLAYER_F1_UNDERWATER,
    OBJ_EVENT_GFX_SILICON_PLAYER_N1_WATERING = OBJ_EVENT_GFX_SILICON_PLAYER_F1_WATERING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_FIELD_MOVE = OBJ_EVENT_GFX_SILICON_PLAYER_F2_FIELD_MOVE,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_FISHING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_FISHING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_MACH_BIKE = OBJ_EVENT_GFX_SILICON_PLAYER_F2_MACH_BIKE,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_NORMAL = OBJ_EVENT_GFX_SILICON_PLAYER_F2_NORMAL,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_SURFING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_SURFING,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_UNDERWATER = OBJ_EVENT_GFX_SILICON_PLAYER_F2_UNDERWATER,
    OBJ_EVENT_GFX_SILICON_PLAYER_N2_WATERING = OBJ_EVENT_GFX_SILICON_PLAYER_F2_WATERING,
};
// End silicon
...
//#define NUM_OBJ_EVENT_GFX                        388 // silicon
...
#define OBJ_EVENT_ID_PARK_RANGER (OBJ_EVENT_ID_FOLLOWER - 1) // siliconMerge
...
enum
{
  OBJ_EVENT_PAL_TAG_BAIYA = OBJ_EVENT_PAL_TAG_SS_ANNE + 1,
  OBJ_EVENT_PAL_TAG_UNKNOWN,
  OBJ_EVENT_PAL_TAG_ADAORA,
  OBJ_EVENT_PAL_TAG_VIGRIM,
  OBJ_EVENT_PAL_TAG_BD,
  OBJ_EVENT_PAL_TAG_BELEN,
  OBJ_EVENT_PAL_TAG_DIMU,
  OBJ_EVENT_PAL_TAG_DOYLE,
  OBJ_EVENT_PAL_TAG_EMRYS,
  OBJ_EVENT_PAL_TAG_IMELDA,
  OBJ_EVENT_PAL_TAG_PUA,
  OBJ_EVENT_PAL_TAG_KEIYING,
  OBJ_EVENT_PAL_TAG_MAGNUS,
  OBJ_EVENT_PAL_TAG_NERIENE,
  OBJ_EVENT_PAL_TAG_SHINZO,
  OBJ_EVENT_PAL_TAG_SILICON,
  OBJ_EVENT_PAL_TAG_SILICON_UNDERWATER = OBJ_EVENT_PAL_TAG_SILICON,
  OBJ_EVENT_PAL_TAG_COMRADE_1,
  OBJ_EVENT_PAL_TAG_COMRADE_2,
  OBJ_EVENT_PAL_TAG_COMRADE_3,
  OBJ_EVENT_PAL_TAG_COMRADE_4,
  OBJ_EVENT_PAL_TAG_COMRADE_5,
  OBJ_EVENT_PAL_TAG_COMRADE_6,
  OBJ_EVENT_PAL_TAG_COMRADE_7,
  OBJ_EVENT_PAL_TAG_COMRADE_8,
  OBJ_EVENT_PAL_TAG_COMRADE_9,
  OBJ_EVENT_PAL_TAG_DESIGNER_1,
  OBJ_EVENT_PAL_TAG_DESIGNER_2,
  OBJ_EVENT_PAL_TAG_DEVELOPER_1,
  OBJ_EVENT_PAL_TAG_DEVELOPER_2,
  OBJ_EVENT_PAL_TAG_FOUNDER_1,
  OBJ_EVENT_PAL_TAG_FOUNDER_2,
  OBJ_EVENT_PAL_TAG_PRODUCT_MANAGER_1,
  OBJ_EVENT_PAL_TAG_PRODUCT_MANAGER_2,
};
  // End silicon
...
#define OBJ_EVENT_PAL_TAG_BALL_VITALITY           OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_PSYCHE             OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWC               OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWD               OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWE               OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWF               OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWG               OBJ_EVENT_PAL_TAG_BALL_NET
#define OBJ_EVENT_PAL_TAG_BALL_NEWH               OBJ_EVENT_PAL_TAG_BALL_NET
// End siliconNewBalls
