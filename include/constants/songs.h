...
enum
{
    ...
    MUS_ESPULEE_OUTSKIRTS,
    MUS_ESPULEE_OUTSKIRTS_NIGHT,
    MUS_ACCEPT_LETTER,
    MUS_VS_WILD_NIGHT,
    MUS_ROUTE4_ROUTE2_NIGHT,
    MUS_CHASILLA_NIGHT,
    MUS_LEATHER_DADDY,
    MUS_PERLACIA_GYM,
    MUS_TORA_GYM,
    MUS_ROUTE_OCEAN_SILICON,
    MUS_ROUTE_OCEAN_SILICON_NIGHT,
    MUS_ESPULEE_OUTSKIRTS_GYM,
    MUS_FORT_YOBU_GYM,
    MUS_HALAI_ISLAND_EARTHQUAKE,
    MUS_HALERBA_CITY,
    MUS_HALERBA_WILDS,
    MUS_RESTORED_TIRABUDIN_PLACE_GYM,
    MUS_TIRABUDIN_PLACE_GYM,
    MUS_ZENZU_ISLAND_GYM,
    MUS_BUG_CATCHER,
    MUS_CAMERAPERSON_REPORTER,
    MUS_VS_LUCREZIA,
    MUS_CURENO_PORT_NIGHT,
    MUS_IRISINA_TOWN,
    MUS_IRISINA_TOWN_NIGHT,
    MUS_QIU_VILLAGE_NIGHT,
    MUS_ZENZU_ROUTE_11_13_100_NIGHT,
    MUS_OKAY_LETS_FIX_IT,
    MUS_PARENT_SCHOOLKID,
    MUS_TOUR_GUIDE_TOURIST,
    MUS_VS_CHARLOTTE,
    MUS_CRESALTA_VISTA_NIGHT,
    MUS_HOBBYIST,
    MUS_CABBIE_ARRIBA,
    MUS_FANCY_PERSON,
    ...
    MUS_EARTHQUAKE,
    MUS_VS_THE_TIDE,
    MUS_HALAI_ISLAND_NIGHT,
    MUS_MERMEREZA_CITY_NIGHT,
    MUS_CAPHE_CITY,
    MUS_CHASILLA,
    MUS_MASTER_DOJO,
    MUS_VS_BAIYA,
    MUS_HALERBA_WILDS_LEAVERRA_FOREST_NIGHT,
    MUS_BALLER,
    ...
    MUS_ENCOUNTER_BIKER,
    MUS_CHASILLA_GYM,
    MUS_ENCOUNTER_BODYBUILDER_TRIATHLETE_SURFER_SCUBADIVER,
    MUS_ENCOUNTER_DESIGNER_DEVELOPER_BIOHACKERS_PRODUCT_MANAGERS_FOUNDER,
    MUS_ENCOUNTER_HEIR,
    MUS_TORA_TOWN_NIGHT,
    MUS_GRAFFITIARTIST_STREETARTIST_PUNK_BUSKER_DANCER_ROBOTPERFORMER_DRAGPERFORMER_JUGGLER,
    MUS_ENCOUNTER_STUDENT,
    MUS_OROLAND,
    MUS_VS_VIGRIM,
    MUS_MERMEREZA_GYM,
    MUS_OROLAND_NIGHT,
    MUS_VICTORY_TOURNAMENT,
    MUS_OBTAIN_KEY_ITEM,
    MUS_HOW_DISAPPOINTING,
    MUS_ENCOUNTER_GAMER_HODLER_INFLUENCER,
    MUS_HALAI_ISLAND_EARTHQUAKE_NIGHT,
    MUS_VIGRIM,
...
#define MUS_PASCAL_FORT_YOBU_GYM           574
