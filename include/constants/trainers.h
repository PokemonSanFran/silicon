...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_BAIYA,
    TRAINER_PIC_FRONT_ADAORA,
    TRAINER_PIC_FRONT_VIGRIM,
    TRAINER_PIC_FRONT_BD,
    TRAINER_PIC_FRONT_BELEN,
    TRAINER_PIC_FRONT_DIMU,
    TRAINER_PIC_FRONT_DOYLE,
    TRAINER_PIC_FRONT_EMRYS,
    TRAINER_PIC_FRONT_IMELDA,
    TRAINER_PIC_FRONT_PUA,
    TRAINER_PIC_FRONT_KEI_YING,
    TRAINER_PIC_FRONT_MAGNUS,
    TRAINER_PIC_FRONT_NERIENE,
    TRAINER_PIC_FRONT_SHINZO,
    TRAINER_PIC_FRONT_SILICON_PLAYER_M1,
    TRAINER_PIC_FRONT_SILICON_PLAYER_M2,
    TRAINER_PIC_FRONT_SILICON_PLAYER_M3,
    TRAINER_PIC_FRONT_SILICON_PLAYER_N1,
    TRAINER_PIC_FRONT_SILICON_PLAYER_N2,
    TRAINER_PIC_FRONT_SILICON_PLAYER_N3,
    TRAINER_PIC_FRONT_SILICON_PLAYER_F1,
    TRAINER_PIC_FRONT_SILICON_PLAYER_F2,
    TRAINER_PIC_FRONT_SILICON_PLAYER_F3,
    TRAINER_PIC_FRONT_COUNT,
    TRAINER_PIC_FRONT_ALICIA                = TRAINER_PIC_FRONT_BRENDAN,
    TRAINER_PIC_FRONT_CHARLOTTE             = TRAINER_PIC_FRONT_MAY,
    TRAINER_PIC_FRONT_OLIVER                = TRAINER_PIC_FRONT_EXPERT_M,
    TRAINER_PIC_FRONT_RAMESH                = TRAINER_PIC_FRONT_MAGMA_ADMIN,
    TRAINER_PIC_FRONT_LUCREZIA              = TRAINER_PIC_FRONT_MAGMA_LEADER_MAXIE,
    TRAINER_PIC_FRONT_TALA                  = TRAINER_PIC_FRONT_ELITE_FOUR_SIDNEY,
    TRAINER_PIC_FRONT_AMI                   = TRAINER_PIC_FRONT_LEADER_JUAN,
    TRAINER_PIC_FRONT_FRANK               = TRAINER_PIC_FRONT_ELITE_FOUR_GLACIA,
    TRAINER_PIC_FRONT_ELEANOR                 = TRAINER_PIC_FRONT_ELITE_FOUR_DRAKE,
    ...
    // Start silicon
    TRAINER_PIC_BACK_BAIYA,
    TRAINER_PIC_BACK_ADAORA,
    TRAINER_PIC_BACK_BD,
    TRAINER_PIC_BACK_BELEN,
    TRAINER_PIC_BACK_DIMU,
    TRAINER_PIC_BACK_DOYLE,
    TRAINER_PIC_BACK_EMRYS,
    TRAINER_PIC_BACK_IMELDA,
    TRAINER_PIC_BACK_PUA,
    TRAINER_PIC_BACK_KEI_YING,
    TRAINER_PIC_BACK_MAGNUS,
    TRAINER_PIC_BACK_NERIENE,
    TRAINER_PIC_BACK_SHINZO,
    TRAINER_PIC_BACK_CHARLOTTE,
    TRAINER_PIC_BACK_OLIVER,
    TRAINER_PIC_BACK_RAMESH,
    TRAINER_PIC_BACK_LUCREZIA,
    TRAINER_PIC_BACK_TALA,
    TRAINER_PIC_BACK_AMI,
    TRAINER_PIC_BACK_FRANK,
    TRAINER_PIC_BACK_ELEANOR,
...
enum TrainerClassID
{
    ...
    // Start silicon
    TRAINER_CLASS_COMRADE,
    TRAINER_CLASS_COMRADE_BAIYA,
    TRAINER_CLASS_EX_LEADER,
    TRAINER_CLASS_SHARPRISE_COO,
    TRAINER_CLASS_SHARPRISE_CEO,
    TRAINER_CLASS_EX_ELITE_FOUR,
    TRAINER_CLASS_THE_TIDE_LEADER,
    TRAINER_CLASS_SHARPRISE_ENFORCER,
    TRAINER_CLASS_CHARLOTTE,
    TRAINER_CLASS_BAIYA,
    TRAINER_CLASS_FINALIST,
    TRAINER_CLASS_ACE_TRAINER,
    TRAINER_CLASS_ARRIBA_DRIVER,
    TRAINER_CLASS_BACKPACKER,
    TRAINER_CLASS_BAKER,
    TRAINER_CLASS_BALLER,
    TRAINER_CLASS_BARISTA,
    TRAINER_CLASS_BELLHOP,
    TRAINER_CLASS_BIKER,
    TRAINER_CLASS_BIOHACKER,
    TRAINER_CLASS_BODYBUILDER,
    TRAINER_CLASS_BUSKER,
    TRAINER_CLASS_CABBIE,
    TRAINER_CLASS_CAMERAPERSON,
    TRAINER_CLASS_CASUAL_DUDE,
    TRAINER_CLASS_CONSTRUCTION_WORKER,
    TRAINER_CLASS_COOK,
    TRAINER_CLASS_DANCER,
    TRAINER_CLASS_DELINQUENT,
    TRAINER_CLASS_DESIGNER,
    TRAINER_CLASS_DEVELOPER,
    TRAINER_CLASS_DOCTOR,
    TRAINER_CLASS_DOGWALKER,
    TRAINER_CLASS_DRAG_PERFORMER,
    TRAINER_CLASS_FANCY_PERSON,
    TRAINER_CLASS_FIREFIGHTER,
    TRAINER_CLASS_FISHER,
    TRAINER_CLASS_FOUNDER,
    TRAINER_CLASS_GAMER,
    TRAINER_CLASS_GARDENER,
    TRAINER_CLASS_GRAFFITI_ARTIST,
    TRAINER_CLASS_HEIR,
    TRAINER_CLASS_HIPPIE,
    TRAINER_CLASS_HOBBYIST,
    TRAINER_CLASS_HODLER,
    TRAINER_CLASS_HUSTLER,
    TRAINER_CLASS_INFIELDER,
    TRAINER_CLASS_INFLUENCER,
    TRAINER_CLASS_JANITOR,
    TRAINER_CLASS_JUGGLER,
    TRAINER_CLASS_LANDLORD,
    TRAINER_CLASS_LEATHER_DADDY,
    TRAINER_CLASS_MARTIAL_ARTIST,
    TRAINER_CLASS_MEGACROSS_SECURITY,
    TRAINER_CLASS_NURSE,
    TRAINER_CLASS_OFFICE_WORKER,
    TRAINER_CLASS_OWNER,
    TRAINER_CLASS_PARENT,
    TRAINER_CLASS_POLICE_OFFICER,
    TRAINER_CLASS_POSTAL_WORKER,
    TRAINER_CLASS_PRODUCT_MANAGER,
    TRAINER_CLASS_PUNK,
    TRAINER_CLASS_RAIL_STAFF,
    TRAINER_CLASS_REPORTER,
    TRAINER_CLASS_ROBOT_PERFORMER,
    TRAINER_CLASS_SCHOOLKID,
    TRAINER_CLASS_SCIENTIST,
    TRAINER_CLASS_SCUBA_DIVER,
    TRAINER_CLASS_SOLICITOR,
    TRAINER_CLASS_STREET_ARTIST,
    TRAINER_CLASS_STREET_VENDOR,
    TRAINER_CLASS_STUDENT,
    TRAINER_CLASS_SURFER,
    TRAINER_CLASS_TOUR_GUIDE,
    TRAINER_CLASS_TOURIST,
    TRAINER_CLASS_TREEHUGGER,
    // End silicon
