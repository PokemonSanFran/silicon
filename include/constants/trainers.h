...
enum __attribute__((packed)) TrainerPicID
{
    ...
    TRAINER_PIC_FRONT_ADELAIDE              = TRAINER_PIC_FRONT_MAGMA_LEADER_MAXIE,
    TRAINER_PIC_FRONT_TALA                  = TRAINER_PIC_FRONT_ELITE_FOUR_SIDNEY,
    TRAINER_PIC_FRONT_AMI                   = TRAINER_PIC_FRONT_LEADER_JUAN,
    TRAINER_PIC_FRONT_ARMANDO               = TRAINER_PIC_FRONT_ELITE_FOUR_GLACIA,
    TRAINER_PIC_FRONT_ELLEN                 = TRAINER_PIC_FRONT_ELITE_FOUR_DRAKE,
    ...
    TRAINER_PIC_BACK_ADELAIDE,
    TRAINER_PIC_BACK_TALA,
    TRAINER_PIC_BACK_AMI,
    TRAINER_PIC_BACK_ARMANDO,
    TRAINER_PIC_BACK_ELLEN,
