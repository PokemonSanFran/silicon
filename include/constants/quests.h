...
#define COST_QUEST_CULTURAL_PURITY_C        (COST_QUEST_CULTURAL_PURITY_A * 3)
#define COST_QUEST_CULTURAL_PURITY_TOTAL    (COST_QUEST_CULTURAL_PURITY_A + COST_QUEST_CULTURAL_PURITY_A COST_QUEST_CULTURAL_PURITY_B + COST_QUEST_CULTURAL_PURITY_C)
