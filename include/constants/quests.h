...
#define MAP_QUEST_FREETHEINNOCENT_STOP_1 MAP_TORGEOT_CLIMB
#define MAP_QUEST_FREETHEINNOCENT_STOP_2 MAP_TORA_TOWN
#define MAP_QUEST_FREETHEINNOCENT_STOP_3 MAP_ANBEH_BEND
