...
#define SUMMARY_NAMEPLATE_FIRST_BASE_TILE 0
#define SUMMARY_NAMEPLATE_MIDDLE_BASE_TILE SUMMARY_NAMEPLATE_FIRST_BASE_TILE + 1
#define SUMMARY_NAMEPLATE_LAST_BASE_TILE SUMMARY_NAMEPLATE_MIDDLE_BASE_TILE + (DISPLAY_TILE_WIDTH - 2)
