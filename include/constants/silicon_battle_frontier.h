...
enum SiliconFrontierStreaKMenu
{
    SILICON_FACILITY_STREAK_MENU_CONTINUE,
    SILICON_FACILITY_STREAK_MENU_QUIT,
    SILICON_FACILITY_STREAK_MENU_LEAVE,
    SILICON_FACILITY_STREAK_MENU_HEAL,
    SILICON_FACILITY_STREAK_MENU_RECORD,
};
