...
enum ArcadeSpriteIds
{
    ARCADE_SPRITEID_PLAYER_SIDE_MON_0,
    ARCADE_SPRITEID_PLAYER_SIDE_MON_1,
    ARCADE_SPRITEID_PLAYER_SIDE_MON_2,
    ARCADE_SPRITEID_PLAYER_SIDE_MON_0,
    ARCADE_SPRITEID_PLAYER_SIDE_SHADOW_1,
    ARCADE_SPRITEID_PLAYER_SIDE_SHADOW_2,
    ARCADE_SPRITEID_PLAYER_SIDE_SHADOW_3,
    ARCADE_SPRITEID_PLAYER_SIDE_SHADOW_3,
    ARCADE_SPRITEID_OPPONENT_SIDE_MON_0,
    ARCADE_SPRITEID_OPPONENT_SIDE_MON_1,
    ARCADE_SPRITEID_OPPONENT_SIDE_MON_2,
    ARCADE_SPRITEID_OPPONENT_SIDE_MON_0,
    ARCADE_SPRITEID_OPPONENT_SIDE_SHADOW_1,
    ARCADE_SPRITEID_OPPONENT_SIDE_SHADOW_2,
    ARCADE_SPRITEID_OPPONENT_SIDE_SHADOW_3,
    ARCADE_SPRITEID_OPPONENT_SIDE_SHADOW_3,
    ARCADE_SPRITEID_EVENT_0,
    ARCADE_SPRITEID_EVENT_1,
    ARCADE_SPRITEID_EVENT_2,
    ARCADE_SPRITEID_EVENT_3,
    ARCADE_SPRITEID_EVENT_4,
    ARCADE_SPRITEID_EVENT_5,
    ARCADE_SPRITEID_EVENT_6,
    ARCADE_SPRITEID_EVENT_7,
    ARCADE_SPRITEID_EVENT_8,
    ARCADE_SPRITEID_EVENT_9,
    ARCADE_SPRITEID_EVENT_10,
    ARCADE_SPRITEID_EVENT_11,
    ARCADE_SPRITEID_EVENT_12,
    ARCADE_SPRITEID_EVENT_13,
    ARCADE_SPRITEID_EVENT_14,
    ARCADE_SPRITEID_EVENT_15,
    ARCADE_SPRITEID_EVENT_16,
    ARCADE_SPRITEID_CURSOR,
    ARCADE_SPRITEID_COUNT,
};
