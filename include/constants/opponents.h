...
enum ResidoTrainerIds
{
    ...
    TRAINER_LEE_PYRON,
    TRAINER_ARANTRAZ_EXHIBIT_A,
    TRAINER_ARANTRAZ_EXHIBIT_B,
    TRAINER_ARANTRAZ_EXHIBIT_C,
    TRAINER_ARANTRAZ_EXHIBIT_D,
    TRAINER_ARANTRAZ_EXHIBIT_E,
    TRAINER_ARANTRAZ_EXHIBIT_F,
