...
// Start siliconMerge
enum ResidoTrainerIds
{
    TRAINER_SHINZO = 1,
    TRAINER_BELEN,
    TRAINER_EMRYS,
    TRAINER_BAIYA_NEWASSHOLEAPPEARS,
    TRAINER_CHARLOTTE_OLDASSHOLEAPPEARS,
    TRAINER_BAIYA_ASSHOLEHOME,
    TRAINER_PUA,
    TRAINER_TALA,
    TRAINER_NERIENE,
    TRAINER_DIMU,
    TRAINER_BD,
    TRAINER_AMIARGENTO,
    TRAINER_BAIYA_BATTLE8,
    TRAINER_CHARLOTTE_BEACHBATTLE,
    TRAINER_VIGRIM,
    TRAINER_VIGRIM_MANHUNT,
    TRAINER_BAIYA_WHYAREYOUHELPINGTHEM,
    TRAINER_LEAGUEOPPONENT1,
    TRAINER_LEAGUEOPPONENT2,
    TRAINER_LEAGUEOPPONENT3,
    TRAINER_LEAGUEOPPONENT4,
    TRAINER_BAIYA_FINALS,
    TRAINER_BAIYA_LETSGRABLUNCH,
    TRAINER_DOYLE_ZENZU_ISLAND,
    TRAINER_IMELDA,
    TRAINER_ADAORA_HOWDISAPPOINTING,
    TRAINER_BAIYA_LETSBURNTHISMOTHERDOWN,
    TRAINER_DIANTHA,
    TRAINER_KEI_YING_WAREHOUSE_RAVE,
    TRAINER_ARRIBA_CEO,
    TRAINER_BUZZR_CEO,
    TRAINER_PRESTO_CEO,
    TRAINER_ARRIBA_CEO_RAID,
    TRAINER_BUZZR_CEO_RAID,
    TRAINER_PRESTO_CEO_RAID,
    TRAINER_RAMESH_IMIN,
    TRAINER_CHARLOTTE_IMIN,
    TRAINER_LUCREZIA_A,
    TRAINER_LUCREZIA_B,
    TRAINER_MAGNUS_PROLOGUE,
    TRAINER_ELEANOR,
    TRAINER_FRANK,
    TRAINER_KEI_YING,
    TRAINER_OLIVER,
    TRAINER_MELISSA_QIU,
    TRAINER_MELISSA_CRESALTA,
    TRAINER_MELISSA_HALAI,
    ...
    TRAINER_SEVENSISTERS_BRADLEY,
    TRAINER_SEVENSISTERS_JO,
    TRAINER_SEVENSISTERS_HANNAH,
    TRAINER_SEVENSISTERS_RACHEL,
    TRAINER_QUEST_RESTAURANTEXPANSIONHOSTESS,
    TRAINER_QUEST_RESTAURANTEXPANSIONCHEF,
    TRAINER_QUEST_RESTAURANTEXPANSIONLINECOOK,
    TRAINER_QUEST_RESTAURANTEXPANSIONBUSSER,
    TRAINER_FAKEROBBER,
    TRAINER_HELEN,
    TRAINER_VAGRANT_1_ROUTE2,
    TRAINER_VAGRANT_2_ROUTE2,
    TRAINER_VAGRANT_3_ROUTE2,
    TRAINER_VAGRANT_4_ROUTE2,
    TRAINER_VAGRANT_5_ROUTE2,
    TRAINER_VAGRANT_1_CURENO_PORT,
    TRAINER_VAGRANT_2_CURENO_PORT,
    TRAINER_VAGRANT_3_CURENO_PORT,
    TRAINER_VAGRANT_4_CURENO_PORT,
    TRAINER_VAGRANT_1_GLAVEZ_HILL,
    TRAINER_VAGRANT_2_GLAVEZ_HILL,
    TRAINER_VAGRANT_3_GLAVEZ_HILL,
    TRAINER_FRANK_ROBOT_1,
    TRAINER_FRANK_ROBOT_2,
    TRAINER_FRANK_ROBOT_3,
    TRAINER_FRANK_ROBOT_4,
    TRAINER_GERTRUDE,
    TRAINER_CABBIE_HALE,
    TRAINER_BUZZR1,
    TRAINER_BUZZR2,
    ...
    TRAINER_BUZZR6,
    TRAINER_REAL_ROBBER,
    TRAINER_PRESTO_GRUNT1,
    TRAINER_PRESTO_GRUNT2,
    TRAINER_PRESTO_GRUNT3,
    TRAINER_PERSUASIVE_LANDLORD,
    TRAINER_ARRIBA_GRUNT1,
    TRAINER_ARRIBA_GRUNT2,
    TRAINER_ARRIBA_GRUNT3,
    TRAINER_IMPROV_1,
    TRAINER_IMPROV_2,
    TRAINER_IMPROV_3,
    TRAINER_MINI_ARCADE_CHRIS,
    TRAINER_LEE_PYRON,
    TRAINER_IMPROV_4,
    TRAINER_IMPROV_5,
    TRAINER_IMPROV_6,
    ...
    TRAINER_C84D5BA6,
    TRAINER_C8563FAA,
    TRAINER_TIRABUDIN_PLACE_GYM_1,
    TRAINER_ANGELDELIVERY_BIKERA,
    TRAINER_INVERSEHALLUCINOGENIC_TRAINER_A,
    TRAINER_INVERSEHALLUCINOGENIC_TRAINER_B,
    TRAINER_INVERSEHALLUCINOGENIC_TRAINER_C,
    TRAINER_INVERSEHALLUCINOGENIC_TRAINER_D,
    TRAINER_INVERSEHALLUCINOGENIC_BD,
    TRAINER_CUTEPOKEMON_A,
    TRAINER_CUTEPOKEMON_B,
    TRAINER_CUTEPOKEMON_C,
    TRAINER_ARTISANBALLS2_A,
    TRAINER_ARTISANBALLS2_B,
    TRAINER_ARTISANBALLS2_C,
    TRAINER_DANCEBATTLE_A,
    TRAINER_DANCEBATTLE_B,
    TRAINER_DANCEBATTLE_C,
    TRAINER_BUILDINGSCOPE_A,
    TRAINER_BUILDINGSCOPE_B,
    TRAINER_BUILDINGSCOPE_C,
    TRAINER_ALOHAFROMALOLA_EMRYS,
    TRAINER_DRUMCIRCLE_A,
    TRAINER_DRUMCIRCLE_B,
    TRAINER_DRUMCIRCLE_C,
    TRAINER_DRUMCIRCLE_D,
    TRAINER_BACKROOMTRAINERA1,
    TRAINER_BACKROOMTRAINERA2,
    TRAINER_BACKROOMTRAINERA3,
    TRAINER_BACKROOMTRAINERA4,
    TRAINER_BACKROOMTRAINERB1,
    TRAINER_BACKROOMTRAINERB2,
    TRAINER_BACKROOMTRAINERB3,
    TRAINER_BACKROOMTRAINERC1,
    TRAINER_BACKROOMTRAINERC2,
    TRAINER_CULTHOUSEGUARD,
    TRAINER_CULTLEADER,
    TRAINER_WALLACEARMY_LEAH,
    TRAINER_HALAI_ISLAND_STAN,
    TRAINER_TIRABUDIN_PLACE_STAN,
    TRAINER_CHASILLA_STAN,
    TRAINER_PERLACIA_CITY_STAN,
    TRAINER_ESPULEE_OUTSKIRTS_STAN,
    TRAINER_SHARPRISESTADIUM_SEMIFINALS,
    TRAINER_SHARPRISESTADIUM_A,
    TRAINER_SHARPRISESTADIUM_B,
    TRAINER_SHARPRISESTADIUM_C,
    TRAINER_CHARLOTTE_IGUESSWESHOULDBENICE,
    TRAINER_CHERIE,
    TRAINER_POLICECHIEF,
    TRAINER_FAKEROCKET_A,
    TRAINER_FAKEROCKET_B,
    TRAINER_ARANTRAZ_GHOST_A,
    TRAINER_ARANTRAZ_GHOST_B,
    TRAINER_ARANTRAZ_GHOST_C,
    TRAINER_ARANTRAZ_GHOST_D,
    TRAINER_HOWDISAPPOINTING_GRUNT1,
    TRAINER_HOWDISAPPOINTING_GRUNT2,
    TRAINER_ANGELDELIVERY_BIKERC,
    TRAINER_ANGELDELIVERY_BIKERD,
    TRAINER_DRUGHELMETTESTER_1,
    TRAINER_DRUGHELMETTESTER_2,
    TRAINER_DRUGHELMETTESTER_3,
    TRAINER_NOPOMOD_NORMAL_1,
    TRAINER_NOPOMOD_FIGHTING_1,
    TRAINER_NOPOMOD_FLYING_1,
    TRAINER_NOPOMOD_POISON_1,
    TRAINER_NOPOMOD_GROUND_1,
    TRAINER_NOPOMOD_ROCK_1,
    TRAINER_NOPOMOD_BUG_1,
    TRAINER_NOPOMOD_GHOST_1,
    TRAINER_NOPOMOD_STEEL_1,
    TRAINER_NOPOMOD_FIRE_1,
    TRAINER_NOPOMOD_WATER_1,
    TRAINER_NOPOMOD_GRASS_1,
    TRAINER_NOPOMOD_ELECTRIC_1,
    TRAINER_NOPOMOD_PSYCHIC_1,
    TRAINER_NOPOMOD_ICE_1,
    TRAINER_NOPOMOD_DRAGON_1,
    TRAINER_NOPOMOD_DARK_1,
    TRAINER_NOPOMOD_FAIRY_1,
    TRAINER_NOPOMOD_NORMAL_2,
    TRAINER_NOPOMOD_FIGHTING_2,
    TRAINER_NOPOMOD_FLYING_2,
    TRAINER_NOPOMOD_POISON_2,
    TRAINER_NOPOMOD_GROUND_2,
    TRAINER_NOPOMOD_ROCK_2,
    TRAINER_NOPOMOD_BUG_2,
    TRAINER_NOPOMOD_GHOST_2,
    TRAINER_NOPOMOD_STEEL_2,
    TRAINER_NOPOMOD_FIRE_2,
    TRAINER_NOPOMOD_WATER_2,
    TRAINER_NOPOMOD_GRASS_2,
    TRAINER_NOPOMOD_ELECTRIC_2,
    TRAINER_NOPOMOD_PSYCHIC_2,
    TRAINER_NOPOMOD_ICE_2,
    TRAINER_NOPOMOD_DRAGON_2,
    TRAINER_NOPOMOD_DARK_2,
    TRAINER_NOPOMOD_FAIRY_2,
    TRAINER_STRESSCUPORGNANIZER,
    TRAINER_STRESSCUPORGNANIZER_PLAYER,
    TRAINER_QUEST_BODEGABURNOUTDELIVERYA,
    TRAINER_QUEST_BODEGABURNOUTDELIVERYB,
    TRAINER_QUEST_BODEGABURNOUTDELIVERYROCKSMASHG,
    TRAINER_QUEST_BODEGABURNOUTDELIVERYCUTD,
    TRAINER_QUEST_BODEGABURNOUTDELIVERYCUTE,
    TRAINER_QUEST_BODEGABURNOUTRESCUEDIVEN,
    TRAINER_QUEST_BODEGABURNOUTRESCUEK,
    TRAINER_QUEST_BODEGABURNOUTRESCUEL,
    TRAINER_QUEST_BODEGABURNOUTRESCUEWHIRLPOOLS,
    TRAINER_QUEST_GETTHEBANDBACKTOGETHERBIKERA,
    TRAINER_QUEST_GETTHEBANDBACKTOGETHERBIKERB,
    TRAINER_QUEST_GETTHEBANDBACKTOGETHERBIKERC,
    TRAINER_QUEST_GETTHEBANDBACKTOGETHERBIKERD,
    ...
    TRAINER_QUEST_FREETHEINNOCENTHIKERD,
    TRAINER_QUEST_FREETHEINNOCENTHIKERD_2,
    TRAINER_QUEST_FREETHEINNOCENTHIKERF,
    TRAINER_QUEST_FREETHEINNOCENTHIKERF_2,
    TRAINER_QUEST_FREETHEINNOCENTHIKERG,
    TRAINER_QUEST_FREETHEINNOCENTHIKERG_2,
    TRAINER_QUEST_FINDTHEGUILTYPLANTH,
    TRAINER_QUEST_FINDTHEGUILTYPLANTH_2,
    TRAINER_00317DFA,
    TRAINER_0049EFE8,
    TRAINER_023957DE,
    TRAINER_006E7EFD,
    ...
    TRAINER_1A2CA162,
    TRAINER_BD_REMATCH,
    TRAINER_BELEN_REMATCH,
    TRAINER_SHINZO_REMATCH,
    TRAINER_EMRYS_REMATCH,
    TRAINER_PUA_REMATCH,
    TRAINER_NERIENE_REMATCH,
    TRAINER_DIMU_REMATCH,
    TRAINER_AMIARGENTO_REMATCH,
    TRAINER_1BC45966,
    TRAINER_1C2B088C,
    TRAINER_1C6CA7F6,
    TRAINER_1CBE4FB1,
