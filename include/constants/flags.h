...
/*
// Mystery Gift Flags (Unknown)
//#define FLAG_MYSTERY_GIFT_DONE               
// I would suggest leaving this one alone, but the following can be removed
// src/event_data.c
// in section void ClearMysteryGiftFlags(void)
...
/*
// src/match_call.c
// in section "static bool32 MapAllowsMatchCall(void)"
...
/*delete this line in the 4 files:
...
// none of these flags are referenced anywhere and can be renamed
#define FLAG_RECEIVED_CONTEST_PASS                         0x406 // Unused, leftover from R/S
#define FLAG_ITEM_ROUTE_123_RARE_CANDY                     0x407 // Unused Flag, leftover from R/S. In Emerald this is a hidden item and uses a different flag
#define FLAG_HIDE_LEGEND_MON_CAVE_OF_ORIGIN                0x408 // Unused, leftover from R/S
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MASTER_BALL        0x409 // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B1F_MAX_ELIXIR         0x40A // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_OLD_MAGMA_HIDEOUT_B2F_NEST_BALL          0x40B // Unused Flag, leftover from the Ruby Magma hideout
#define FLAG_ITEM_MOSSDEEP_STEVENS_HOUSE_HM08              0x40C // Unused Flag, leftover from R/S. HM08 is given to the player directly in Emerald


//placed here to make the TRAINER_FLAGS_START begin at a 0 flag
#define FLAG_UNUSED_0x40D                        0x40D // Unused Flag
#define FLAG_UNUSED_0x40E                        0x40E // Unused Flag
#define FLAG_UNUSED_0x40F                        0x40F // Unused Flag
...
//these 3 flags are not referenced in other files and can be renamed
#define FLAG_SYS_CAVE_SHIP                          (SYSTEM_FLAGS + 0x77) // Unused Flag, leftover from R/S debug, presumably used by Emerald's debug too
#define FLAG_SYS_CAVE_WONDER                        (SYSTEM_FLAGS + 0x78) // Unused Flag, same as above
#define FLAG_SYS_CAVE_BATTLE                        (SYSTEM_FLAGS + 0x79) // Unused Flag, same as above
