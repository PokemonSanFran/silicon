...
enum HoldEffect GetMonHoldEffect(struct Pokemon *mon); // Battle Settings: Experience
...
u8 GetCatchingAttacker(void); // siliconMerge
...
u32 ComputeCaptureOdds(u32 wildMonBattler, u32 playerBattler); // last_used_ball
