...
u8 CreateCustomMon(enum Species species, u8 level, u16 item, u8 ball, u8 nature, u8 abilityNum, u8 *evs, u8 *ivs, u16 *moves, bool8 isShiny); // siliconMerge
...
bool32 IsSpeciesFromAlola(enum Species species); // pokedex
