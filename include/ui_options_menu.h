...
#define NUM_OPTIONS_MAX_SETTINGS    (max((u32)NUM_OPTIONS_MUSIC_SETTINGS,        \
                                    max((u32)NUM_OPTIONS_RANDOM_SETTINGS,\
                                    max((u32)NUM_OPTIONS_GAME_SETTINGS,\
                                    max((u32)NUM_OPTIONS_BATTLE_SETTINGS,\
                                        (u32)NUM_OPTIONS_VISUAL_SETTINGS)))))
...
enum optionsMusicSpeaker
{
  MUSIC_OPTIONS_SPEAKER_MONO,
  MUSIC_OPTIONS_SPEAKER_STEREO,
  MUSIC_OPTIONS_SPEAKER_COUNT,
};
...
enum optionsMusicSurf
{
  MUSIC_OPTION_SURF_RESIDO,
  MUSIC_OPTION_SURF_TOHJO,
  MUSIC_OPTION_SURF_HOENN,
  MUSIC_OPTION_SURF_SINNOH,
  MUSIC_OPTION_SURF_UNOVA,
  MUSIC_OPTION_SURF_KALOS,
  MUSIC_OPTION_SURF_ALOLA,
  MUSIC_OPTION_SURF_MANTINE,
  MUSIC_SURF_OPTIONS_COUNT,
};

enum optionsMusicBicycle
{
  MUSIC_OPTION_BIKE_RESIDO,
  MUSIC_OPTION_BIKE_KANTO,
  MUSIC_OPTION_BIKE_JOHTO,
  MUSIC_OPTION_BIKE_HOENN,
  MUSIC_OPTION_BIKE_SINNOH,
  MUSIC_OPTION_BIKE_UNOVA,
  MUSIC_OPTION_BIKE_KALOS,
  MUSIC_OPTION_BIKE_ALOLA,
  MUSIC_BIKE_OPTIONS_COUNT,
};

enum optionsMusicBattleWild
{
  MUSIC_OPTION_BATTLE_WILD_RESIDO,
  MUSIC_OPTION_BATTLE_WILD_KANTO,
  MUSIC_OPTION_BATTLE_WILD_JOHTO,
  MUSIC_OPTION_BATTLE_WILD_HOENN,
  MUSIC_OPTION_BATTLE_WILD_SINNOH,
  MUSIC_OPTION_BATTLE_WILD_UNOVA,
  MUSIC_OPTION_BATTLE_WILD_KALOS,
  MUSIC_OPTION_BATTLE_WILD_ALOLA,
  MUSIC_OPTION_BATTLE_WILD_GALAR,
  MUSIC_OPTION_BATTLE_WILD_PALDEA,
  MUSIC_BATTLE_WILD_OPTIONS_COUNT,
};

enum optionsMusicBattleTrainer
{
  MUSIC_OPTION_BATTLE_TRAINER_RESIDO,
  MUSIC_OPTION_BATTLE_TRAINER_KANTO,
  MUSIC_OPTION_BATTLE_TRAINER_JOHTO,
  MUSIC_OPTION_BATTLE_TRAINER_HOENN,
  MUSIC_OPTION_BATTLE_TRAINER_SINNOH,
  MUSIC_OPTION_BATTLE_TRAINER_UNOVA,
  MUSIC_OPTION_BATTLE_TRAINER_KALOS,
  MUSIC_OPTION_BATTLE_TRAINER_ALOLA,
  MUSIC_OPTION_BATTLE_TRAINER_GALAR,
  MUSIC_OPTION_BATTLE_TRAINER_PALDEA,
  MUSIC_BATTLE_TRAINER_OPTIONS_COUNT,
};

enum optionsMusicBattleGym
{
  MUSIC_OPTION_BATTLE_GYM_RESIDO,
  MUSIC_OPTION_BATTLE_GYM_KANTO,
  MUSIC_OPTION_BATTLE_GYM_JOHTO,
  MUSIC_OPTION_BATTLE_GYM_HOENN,
  MUSIC_OPTION_BATTLE_GYM_SINNOH,
  MUSIC_OPTION_BATTLE_GYM_UNOVA,
  MUSIC_OPTION_BATTLE_GYM_KALOS,
  MUSIC_OPTION_BATTLE_GYM_ALOLA,
  MUSIC_OPTION_BATTLE_GYM_GALAR,
  MUSIC_OPTION_BATTLE_GYM_PALDEA,
  MUSIC_BATTLE_GYM_OPTIONS_COUNT,
};

enum optionsMusicBattleTournament
{
  MUSIC_OPTION_BATTLE_TOURNAMENT_RESIDO,
  MUSIC_OPTION_BATTLE_TOURNAMENT_TOHJO,
  MUSIC_OPTION_BATTLE_TOURNAMENT_HOENN,
  MUSIC_OPTION_BATTLE_TOURNAMENT_SINNOH,
  MUSIC_OPTION_BATTLE_TOURNAMENT_UNOVA,
  MUSIC_OPTION_BATTLE_TOURNAMENT_KALOS,
  MUSIC_OPTION_BATTLE_TOURNAMENT_ALOLA,
  MUSIC_OPTION_BATTLE_TOURNAMENT_GALAR,
  MUSIC_OPTION_BATTLE_TOURNAMENT_PALDEA,
  MUSIC_OPTION_BATTLE_TOURNAMENT_COUNT,
};

enum optionsMusicBattleChampion
{
  MUSIC_OPTION_BATTLE_CHAMPION_RESIDO,
  MUSIC_OPTION_BATTLE_CHAMPION_KANTO_OLD,
  MUSIC_OPTION_BATTLE_CHAMPION_KANTO_NEW,
  MUSIC_OPTION_BATTLE_CHAMPION_HOENN,
  MUSIC_OPTION_BATTLE_CHAMPION_SINNOH,
  MUSIC_OPTION_BATTLE_CHAMPION_UNOVA_OLD,
  MUSIC_OPTION_BATTLE_CHAMPION_UNOVA_NEW,
  MUSIC_OPTION_BATTLE_CHAMPION_KALOS,
  MUSIC_OPTION_BATTLE_CHAMPION_ALOLA,
  MUSIC_OPTION_BATTLE_CHAMPION_GALAR,
  MUSIC_OPTION_BATTLE_CHAMPION_PALDEA,
  MUSIC_BATTLE_CHAMPION_OPTIONS_COUNT,
};
...
enum optionVisualTime
{
  VISUAL_OPTION_24_HOUR,
  VISUAL_OPTION_12_HOUR,
  VISUAL_OPTION_TIME_COUNT,
};
...
enum ArrowIds
{
  OPTIONS_SPRITE_ID_ARROW_UP,
  OPTIONS_SPRITE_ID_ARROW_DOWN,
  OPTIONS_SPRITE_ID_ARROW_LEFT,
  OPTIONS_SPRITE_ID_ARROW_RIGHT,
  OPTIONS_SPRITE_ID_ARROW_COUNT,
  OPTIONS_SPRITETAG_ARROW_UP = (6969 + OPTIONS_SPRITE_ID_ARROW_UP),
  OPTIONS_SPRITETAG_ARROW_DOWN,
  OPTIONS_SPRITETAG_ARROW_LEFT,
  OPTIONS_SPRITETAG_ARROW_RIGHT,
};

#define ARROW_UP_POSITION_X 56
#define ARROW_UP_POSITION_Y 12
#define ARROW_DOWN_POSITION_X ARROW_UP_POSITION_X
#define ARROW_DOWN_POSITION_Y ARROW_UP_POSITION_Y + 88
#define ARROW_LEFT_POSITION_X 157
#define ARROW_LEFT_POSITION_Y 24
#define ARROW_RIGHT_POSITION_X ARROW_LEFT_POSITION_X + 73
#define ARROW_RIGHT_POSITION_Y ARROW_LEFT_POSITION_Y
