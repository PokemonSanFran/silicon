...
const u8 *const sTerrainNames[BATTLE_TERRAIN_COUNT] =
{
    [BATTLE_TERRAIN_GRASS] = COMPOUND_STRING("Grass"),
    [BATTLE_TERRAIN_LONG_GRASS] = COMPOUND_STRING("Long Grass"),
    [BATTLE_TERRAIN_SAND] = COMPOUND_STRING("Sand"),
    [BATTLE_TERRAIN_UNDERWATER] = COMPOUND_STRING("Underwater"),
    [BATTLE_TERRAIN_WATER] = COMPOUND_STRING("Water"),
    [BATTLE_TERRAIN_POND] = COMPOUND_STRING("Pond"),
    [BATTLE_TERRAIN_MOUNTAIN] = COMPOUND_STRING("Mountain"),
    [BATTLE_TERRAIN_CAVE] = COMPOUND_STRING("Cave"),
    [BATTLE_TERRAIN_BUILDING] = COMPOUND_STRING("Building"),
    [BATTLE_TERRAIN_PLAIN] = COMPOUND_STRING("Plain"),
    [BATTLE_TERRAIN_SOARING] = COMPOUND_STRING("Soaring"),
    [BATTLE_TERRAIN_SKY_PILLAR] = COMPOUND_STRING("Sky Pillar"),
    [BATTLE_TERRAIN_BURIAL_GROUND] = COMPOUND_STRING("Burial Ground"),
    [BATTLE_TERRAIN_PUDDLE] = COMPOUND_STRING("Puddle"),
    [BATTLE_TERRAIN_MARSH] = COMPOUND_STRING("Marsh"),
    [BATTLE_TERRAIN_SWAMP] = COMPOUND_STRING("Swamp"),
    [BATTLE_TERRAIN_SNOW] = COMPOUND_STRING("Snow"),
    [BATTLE_TERRAIN_ICE] = COMPOUND_STRING("Ice"),
    [BATTLE_TERRAIN_VOLCANO] = COMPOUND_STRING("Volcano"),
    [BATTLE_TERRAIN_DISTORTION_WORLD] = COMPOUND_STRING("Distortion World"),
    [BATTLE_TERRAIN_SPACE] = COMPOUND_STRING("Space"),
    [BATTLE_TERRAIN_ULTRA_SPACE] = COMPOUND_STRING("Ultra_Space"),
};
