...
// End fishingUpdate
#include "constants/wild_encounter_silicon.h" // wildEncounters
...
{
    gSpecialVar_Result = (GetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_IS_SHINY));
    return gSpecialVar_Result;
}

bool8 IsOverworldMonFemale(void)
{
    u32 gender = GetMonGender(&gParties[B_TRAINER_OPPONENT_A][0]);
