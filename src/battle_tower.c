...
const BossSlot gFacilityBosses[NUM_BOSS_SLOTS] = {
    {FRONTIER_TRAINER_HUGO, FLAG_FACILITY_UNLOCK_PUA},
    {FRONTIER_TRAINER_COREY, FLAG_FACILITY_UNLOCK_BAIYA},
    ...
    {FRONTIER_TRAINER_FERRIS, FLAG_FACILITY_UNLOCK_FRANK},
    //{TRAINER_FRONTIER_BRAIN, FLAG_HIDE_FACILITY_OPPONENT},
...
u16 PSF_GetNormalFrontierTrainerID(void)
{
    ...
    return GetRandomScaledFrontierTrainerId(7, 0);
}
