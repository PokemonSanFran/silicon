...
void PlayerBufferExecCompleted(enum BattlerId battler) // quick_run
//static PlayerBufferExecCompleted(enum BattlerId battler) // quick_run
{
    gBattlerControllerFuncs[battler] = PlayerBufferRunCommand;
...
{
    TRAINER_PIC_BACK_SILICON_PLAYER_M1,
    TRAINER_PIC_BACK_SILICON_PLAYER_M2,
    TRAINER_PIC_BACK_SILICON_PLAYER_M3,
    TRAINER_PIC_BACK_SILICON_PLAYER_N1,
    TRAINER_PIC_BACK_SILICON_PLAYER_N2,
    TRAINER_PIC_BACK_SILICON_PLAYER_N3,
    TRAINER_PIC_BACK_SILICON_PLAYER_F1,
    TRAINER_PIC_BACK_SILICON_PLAYER_F2,
    TRAINER_PIC_BACK_SILICON_PLAYER_F3,
...
static void Controller_WaitForEvo(enum BattlerId battler)
{
    if (gMain.callback2 == BattleMainCB2 && !gPaletteFade.active)
    {
