...
// Start inventory
u8 LoadMonIconPaletteWithAilment(enum Species species, u32 personality, u32 ailment, u16 currentHP, u8 paletteNum)
{
    u8 palIndex;
    ...
    if(species == SPECIES_EGG){
        ...
        switch(ailment){
            case AILMENT_BRN:
                BlendPalette(paletteIndex, 16, 6, RGB_RED);
                break;
            case AILMENT_PRZ:
                BlendPalette(paletteIndex, 16, 6, RGB_YELLOW);
                break;
            case AILMENT_FRZ:
            case AILMENT_FRB:
                BlendPalette(paletteIndex, 16, 6, RGB_BLUE);
                break;
            case AILMENT_PSN:
                BlendPalette(paletteIndex, 16, 6, RGB_PURPLE);
                break;
            case AILMENT_SLP:
                BlendPalette(paletteIndex, 16, 6, RGB_WHITE);
                break;
            default:
                return paletteNum;
                break;
...
u8 LoadMonIconPaletteWithRGBValue(enum Species species, u32 personality, u32 blendColor, u16 currentHP, u8 paletteNum)
{
    u8 palIndex;
    u16 paletteIndex = (16 + paletteNum) * 16;
