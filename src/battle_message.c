...
// Start pointsMessage
    [STRINGID_ATTACKERFAINTED_NOBREAK]              = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} fainted!"),
    [STRINGID_TARGETFAINTED_NOBREAK]                = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} fainted!"),
// End pointsMessage
