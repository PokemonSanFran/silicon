...
#include "quest_ow.h" // siliconMerge
...
static const u8 sMapSectionToThemeId[MAPSEC_COUNT - KANTO_MAPSEC_COUNT - 1] =
{
	...
	// Start siliconMerge
    [MAPSEC_QIU_VILLAGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HALERBA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PETAROSA_BOROUGH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CRESALTA_VISTA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_IRISINA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_MERMEREZA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CURENO_PORT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CUCONU_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_OROLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ESPULEE_OUTSKIRTS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CHASILLA] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_CAPHE_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HODOU_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TORA_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PERLACIA_CITY] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_GLAVEZ_HILL] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HALAI_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_TIRABUDIN_PLACE] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_WISHAAST_LAKE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_WAJABI_LAKE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ZENZU_ISLAND] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ARANTRAZ] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE11] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE16] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE22] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE18] = MAPPOPUP_THEME_WOOD,
    ...
    [MAPSEC_SECRET_PATH] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_NONGYU_BRIDGE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE20] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE9] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE7] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE13] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_A] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE100] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE98] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE99] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE12] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_B] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_ROUTE_E] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_HALERBAWILDS] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_SHARPRISESPIRE] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_PARC] = MAPPOPUP_THEME_WOOD
};
