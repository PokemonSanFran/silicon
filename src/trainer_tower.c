...
static const u16 sFloorLayouts[MAX_TRAINER_TOWER_FLOORS][NUM_TOWER_CHALLENGE_TYPES - 1] = {
    {LAYOUT_TRAINER_TOWER_1F_FRLG, LAYOUT_TRAINER_TOWER_1F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_1F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_2F_FRLG, LAYOUT_TRAINER_TOWER_2F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_2F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_3F_FRLG, LAYOUT_TRAINER_TOWER_3F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_3F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_4F_FRLG, LAYOUT_TRAINER_TOWER_4F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_4F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_5F_FRLG, LAYOUT_TRAINER_TOWER_5F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_5F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_6F_FRLG, LAYOUT_TRAINER_TOWER_6F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_6F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_7F_FRLG, LAYOUT_TRAINER_TOWER_7F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_7F_KNOCKOUT_FRLG},
    {LAYOUT_TRAINER_TOWER_8F_FRLG, LAYOUT_TRAINER_TOWER_8F_DOUBLES_FRLG, LAYOUT_TRAINER_TOWER_8F_KNOCKOUT_FRLG}
};
...
static void SetUpTrainerTowerDataStruct(void)
{
    ...
    sTrainerTowerState->floorIdx = gMapHeader.mapLayoutId - LAYOUT_TRAINER_TOWER_1F_FRLG;
...
static void InitTrainerTowerFloor(void)
{
    if (gMapHeader.mapLayoutId - LAYOUT_TRAINER_TOWER_LOBBY_FRLG > sTrainerTowerState->data.numFloors)
    {
        gSpecialVar_Result = 3; // Skip past usable challenge types
        SetCurrentMapLayout(LAYOUT_TRAINER_TOWER_ROOF_FRLG);
    }
    else
    {
...
static void GetFloorAlreadyCleared(void)
{
    ...
    if (mapLayoutId - LAYOUT_TRAINER_TOWER_1F_FRLG == TRAINER_TOWER.floorsCleared 
     && mapLayoutId - LAYOUT_TRAINER_TOWER_LOBBY_FRLG <= CURR_FLOOR.floorIdx)
...
static void ShouldWarpToCounter(void)
{
    if (gMapHeader.mapLayoutId == LAYOUT_TRAINER_TOWER_LOBBY_FRLG && VarGet(VAR_MAP_SCENE_TRAINER_TOWER) == 0)
        gSpecialVar_Result = FALSE;
    else
        gSpecialVar_Result = FALSE;
}
...
#else
    u8 floorIdx = gMapHeader.mapLayoutId - LAYOUT_TRAINER_TOWER_1F_FRLG;
#endif //FREE_TRAINER_TOWER
    s32 i;
    u8 monIdx;
