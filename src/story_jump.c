...
void FlagsVarWarp_Prologue_Intro()
{
    ...
    SetWarpDestination(MAP_GROUP(OROLAND_COLISEUM_HALLWAY), MAP_NUM(OROLAND_COLISEUM_HALLWAY), NO_WARP_ID, 5, 12);
}
...
void FlagsVarWarp_Prologue_Champion(void)
{
    ...
    SetWarpDestination(MAP_GROUP(OROLAND_COLISEUM_HALL), MAP_NUM(OROLAND_COLISEUM_HALL), NO_WARP_ID, 9, 8);
}
...
void FlagsVarWarp_Prologue_Announcement(void)
{
    ...
    SetWarpDestination(MAP_GROUP(OROLAND_COLISEUM_HALL), MAP_NUM(OROLAND_COLISEUM_HALL), NO_WARP_ID, 9, 7);
}
...
void FlagsVarWarp_StarterChoice(void)
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN), MAP_NUM(CUCONU_TOWN), 0, 3, 10);
}
...
void FlagsVarWarp_ImProbablyBetterThanYou(void)
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN_SHARPRISE_COMPOUND_1F), MAP_NUM(CUCONU_TOWN_SHARPRISE_COMPOUND_1F), 2, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_swagbag(void)
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN_SHARPRISE_COMPOUND_1F), MAP_NUM(CUCONU_TOWN_SHARPRISE_COMPOUND_1F), 0, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_CatchTutorial()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE6),MAP_NUM(ROUTE6),NO_WARP_ID,10,19);
}
...
void FlagsVarWarp_EnterFallkner()
{
    ...
    SetWarpDestination(MAP_GROUP(MERMEREZA_CITY_GYM),MAP_NUM(MERMEREZA_CITY_GYM),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_EnterShinzo()
{
    ...
    IncrementStorylineVariable();
    WowYoureStrong_GetBadgesAndSetTowerState();
    SetWarpDestination(MAP_GROUP(TORA_TOWN_GYM),MAP_NUM(TORA_TOWN_GYM),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_EnterEmrys()
{
    ...
    IncrementStorylineVariable();
    WowYoureStrong_GetBadgesAndSetTowerState();
    SetWarpDestination(MAP_GROUP(PERLACIA_CITY_GYM),MAP_NUM(PERLACIA_CITY_GYM),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_NewAssholeAppears()
{
    ...
    IncrementStorylineVariable();
    SetWarpDestination(MAP_GROUP(ROUTE10),MAP_NUM(ROUTE10),NO_WARP_ID,2,4);
}
...
void FlagsVarWarp_OldAssholeAppears()
{
    ...
    SetWarpDestination(MAP_GROUP(ANBEH_BEND),MAP_NUM(ANBEH_BEND),NO_WARP_ID,15,11);
}
...
void FlagsVarWarp_GroupofAssholesAppears()
{
    ...
    SetWarpDestination(MAP_GROUP(POPIDORA_PIER),MAP_NUM(POPIDORA_PIER),NO_WARP_ID,31,5);
}
...
void FlagsVarWarp_FlyingBlind()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE11), MAP_NUM(ROUTE11), NO_WARP_ID, 79, 15);
}
...
void FlagsVarWarp_WowYoureStrong()
{
    ...
    SetWarpDestination(MAP_GROUP(PERLACIA_CITY),MAP_NUM(PERLACIA_CITY),8, USE_WARP_ID, USE_WARP_ID);
...
void FlagsVarWarp_TheGangsAllHere()
{
    ...
    IncrementStorylineVariable();
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS), MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS), NO_WARP_ID, 5, 53);
}
...
void FlagsVarWarp_AlwaysWatchingWazokwski()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_PRODUCTION),MAP_NUM(SHARPRISE_SPIRE_PRODUCTION),NO_WARP_ID,9,7);
...
void FlagsVarWarp_EnterAdaora()
{
    ...
    SetWarpDestination(MAP_GROUP(CAPHE_CITY),MAP_NUM(CAPHE_CITY),NO_WARP_ID,2,40);
}
...
void FlagsVarWarp_HowDoWeGetHome()
{
    ...
    IncrementStorylineVariable();
    SetWarpDestination(MAP_GROUP(CURENO_PORT),MAP_NUM(CURENO_PORT),NO_WARP_ID,11,21);
}
...
void FlagsVarWarp_AaandWereBack()
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN),MAP_NUM(CUCONU_TOWN),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_AssholesHome()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND),MAP_NUM(HALAI_ISLAND),NO_WARP_ID,20,5);
}
...
void FlagsVarWarp_HousingProtest()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE99),MAP_NUM(ROUTE99),NO_WARP_ID,7,14);
...
void FlagsVarWarp_swagbag2()
{
    ...
    SetWarpDestination(MAP_GROUP(CHASILLA),MAP_NUM(CHASILLA),NO_WARP_ID,4,13);
...
void FlagsVarWarp_EnterKauna()
{
    ...
    SetWarpDestination(MAP_GROUP(CHASILLA_GYM),MAP_NUM(CHASILLA_GYM),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_SorryAboutMyFriends()
{
    ...
    SetWarpDestination(MAP_GROUP(CHASILLA),MAP_NUM(CHASILLA),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_TheStorySoFar(u32 trainer)
{
    switch(trainer)
    {
        case JUMPPLAYER_THESTORYSOFAR_A:
            ...
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,29,60);
            break;
        case JUMPPLAYER_THESTORYSOFAR_B:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_B);
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,37,13);
            break;
        case JUMPPLAYER_THESTORYSOFAR_C:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_C);
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,25,10);
            break;
        case JUMPPLAYER_THESTORYSOFAR_D:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_D);
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,8,35);
            break;
        case JUMPPLAYER_THESTORYSOFAR_E:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_E);
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,27,22);
            break;
        case JUMPPLAYER_THESTORYSOFAR_F:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_F);
            SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,17,51);
            break;
        case JUMPPLAYER_THESTORYSOFAR_ALL:
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_A);
            FlagSet(TRAINER_FLAGS_START + TRAINER_ARANTRAZ_EXHIBIT_B);
...
void FlagsVarWarp_YoungPadawan()
{
    ...
    SetWarpDestination(MAP_GROUP(ARANTRAZ),MAP_NUM(ARANTRAZ),NO_WARP_ID,37,59);
}
...
void FlagsVarWarp_WaitYouWentWhere()
{
    ...
    SetWarpDestination(MAP_GROUP(PSFROUTE9F45DA86),MAP_NUM(PSFROUTE9F45DA86),NO_WARP_ID,3,1);
}
...
void FlagsVarWarp_EnterNeriene()
{
    ...
    SetWarpDestination(MAP_GROUP(FORT_YOBU_GYM),MAP_NUM(FORT_YOBU_GYM), 0, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_FriendsForDinner()
{
    ...
    SetWarpDestination(MAP_GROUP(FORT_YOBU), MAP_NUM(FORT_YOBU), 0, USE_WARP_ID, USE_WARP_ID);
...
void FlagsVarWarp_Keiyingsraisondetre()
{
    ...
    SetWarpDestination(MAP_GROUP(PETAROSA_BOROUGH),MAP_NUM(PETAROSA_BOROUGH),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_BeachBattle()
{
    ...
    SetWarpDestination(MAP_GROUP(CRESALTA_VISTA), MAP_NUM(CRESALTA_VISTA), NO_WARP_ID, 10, 23);
...
void FlagsVarWarp_EnterDimu()
{
    ...
    SetWarpDestination(MAP_GROUP(HALERBA_CITY_GYM), MAP_NUM(HALERBA_CITY_GYM),2, USE_WARP_ID, USE_WARP_ID);
...
void FlagsVarWarp_AndWeMarchOn()
{
    ...
    SetWarpDestination(MAP_GROUP(TIRABUDIN_PLACE),MAP_NUM(TIRABUDIN_PLACE),NO_WARP_ID, 23, 7);
}
...
void FlagsVarWarp_EnterBD()
{
    ...
    SetWarpDestination(MAP_GROUP(TIRABUDIN_PLACE_GYM_LOBBY), MAP_NUM(TIRABUDIN_PLACE_GYM_LOBBY), 1, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_Battle8()
{
    ...
    SetWarpDestination(MAP_GROUP(PINTILLON_HOUSE_EXTERIOR),MAP_NUM(PINTILLON_HOUSE_EXTERIOR),NO_WARP_ID,19,16);
...
void FlagsVarWarp_EnterAmiArgento()
{
    ...
    SetWarpDestination(MAP_GROUP(IRISINA_TOWN_GYM),MAP_NUM(IRISINA_TOWN_GYM),0,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_TheStrikeStrikesBack()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE2),MAP_NUM(ROUTE2),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_OffYouGo_Phone()
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN_SHARPRISE_COMPOUND_2F),MAP_NUM(CUCONU_TOWN_SHARPRISE_COMPOUND_2F),0,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_OffYouGo_Bridge(void)
{
    ...
    SetWarpDestination(MAP_GROUP(PIOCA_BRIDGE),MAP_NUM(PIOCA_BRIDGE),0,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_IGuessWeShouldBeNiceNow()
{
    ...
    SetWarpDestination(MAP_GROUP(ESPULEE_OUTSKIRTS_KOMALA_CABIN_1F),MAP_NUM(ESPULEE_OUTSKIRTS_KOMALA_CABIN_1F),2,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_EntertheMaster()
{
    ...
    SetWarpDestination(MAP_GROUP(LEAVERRA_FOREST_INNER),MAP_NUM(LEAVERRA_FOREST_INNER),2,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_HaveYouSeenTheNews()
{
    ...
    SetWarpDestination(MAP_GROUP(LEAVERRA_FOREST_INNER),MAP_NUM(LEAVERRA_FOREST_INNER),1,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_WelcometotheWarRoom()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS),MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS),NO_WARP_ID,17,29);
...
void FlagsVarWarp_SurvivalChance333()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND),MAP_NUM(HALAI_ISLAND),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_WhyAreYouHelpingThem()
{
    ...
    SetWarpDestination(MAP_GROUP(CUCONU_TOWN_SHARPRISE_COMPOUND_1F),MAP_NUM(CUCONU_TOWN_SHARPRISE_COMPOUND_1F),NO_WARP_ID,11,4);
}
...
void FlagsVarWarp_WhyAreYouHelpingThemSleep()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_STADIUM_LOCKERS),MAP_NUM(SHARPRISE_STADIUM_LOCKERS),NO_WARP_ID,9,6);
...
void FlagsVarWarp_HeresHowThisIsGoingToGo()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_STADIUM_LOCKERS),MAP_NUM(SHARPRISE_STADIUM_LOCKERS),0,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_WhyDidntYouRatMeOut()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_STADIUM_SKYBOX),MAP_NUM(SHARPRISE_STADIUM_SKYBOX),0, USE_WARP_ID, USE_WARP_ID);
...
void FlagsVarWarp_GroupStages()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_STADIUM_LOCKERS),MAP_NUM(SHARPRISE_STADIUM_LOCKERS),NO_WARP_ID,10,3);
...
void FlagsVarWarp_WelcometotheHallofFame()
{
    ...
    SetWarpDestination(MAP_GROUP(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F),MAP_NUM(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F),NO_WARP_ID,11,4);
}
...
void FlagsVarWarp_BeingChampionisHard()
{
    ...
    SetWarpDestination(MAP_GROUP(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F),MAP_NUM(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F),NO_WARP_ID,7,9);
}
...
void FlagsVarWarp_LetsGrabLunch()
{
    ...
    SetWarpDestination(MAP_GROUP(ZENZU_ISLAND_RESTAURANT),MAP_NUM(ZENZU_ISLAND_RESTAURANT),NO_WARP_ID,14,9);
}
...
void FlagsVarWarp_RestoreHodouCity()
{
    ...
    SetWarpDestination(MAP_GROUP(HODOU_CITY_GYM),MAP_NUM(HODOU_CITY_GYM),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_RestoreZenzuIsland()
{
    ...
    QuestMenu_GetSetQuestState(QUEST_RESTOREZENZUGYM,
            FLAG_SET_COMPLETED);
    SetWarpDestination(MAP_GROUP(ZENZU_ISLAND),MAP_NUM(ZENZU_ISLAND),NO_WARP_ID,3,15);
}
...
void FlagsVarWarp_RestoreEspuleeOutskirts()
{
    ...
    SetWarpDestination(MAP_GROUP(ESPULEE_OUTSKIRTS),MAP_NUM(ESPULEE_OUTSKIRTS),NO_WARP_ID,8,18);
...
void FlagsVarWarp_YouRealizeTheyreEvilRight_Phone(void)
{
    ...
    SetWarpDestination(MAP_GROUP(PERLACIA_CITY), MAP_NUM(PERLACIA_CITY), 0, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_YouRealizeTheyreEvilRight_Island()
{
    ...
    SetWarpDestination(MAP_GROUP(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F), MAP_NUM(PETAROSA_BOROUGH_SHARPRISE_COMPOUND_1F), 0, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_YouHaveYourOrders()
{
    ...
    SetWarpDestination(MAP_GROUP(HODOU_CITY), MAP_NUM(HODOU_CITY), NO_WARP_ID, 33, 8);
}
...
void FlagsVarWarp_HowDisappointing_Raid(void)
{
    ...
    SetWarpDestination(MAP_GROUP(HODOU_CITY), MAP_NUM(HODOU_CITY), NO_WARP_ID,22,4);
}
...
void FlagsVarWarp_HowDisappointing_Arrest(void)
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS), MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS), NO_WARP_ID, 32,53);
}
...
void FlagsVarWarp_LetsBurnThisMotherDown()
{
    ...
    IncrementStorylineVariable();
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS), MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS), NO_WARP_ID, 34,5);
...
void FlagsVarWarp_Manhunt_News()
{
    ...
    SetWarpDestination(MAP_GROUP(PERLACIA_CITY_NEWSPAPER), MAP_NUM(PERLACIA_CITY_NEWSPAPER), NO_WARP_ID,12,8);
...
void FlagsVarWarp_Manhunt_Business()
{
    ...
    SetWarpDestination(MAP_GROUP(MERMEREZA_CITY_CONSULTING), MAP_NUM(MERMEREZA_CITY_CONSULTING), 1,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_Manhunt_Ball()
{
    ...
    SetWarpDestination(MAP_GROUP(IRISINA_TOWN_BALLS),MAP_NUM(IRISINA_TOWN_BALLS),NO_WARP_ID,6,6);
}
...
void FlagsVarWarp_Manhunt_Route()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE98), MAP_NUM(ROUTE98), NO_WARP_ID,25,22);
}
...
void FlagsVarWarp_Manhunt_Alcmene()
{
    ...
    IncrementStorylineVariable();
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS), MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS), NO_WARP_ID, 5,5);
}
...
void FlagsVarWarp_ExhibitionBattle()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_STADIUM_LOCKERS),MAP_NUM(SHARPRISE_STADIUM_LOCKERS),2,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_MaybeIFuckedUp()
{
    ...
    SetWarpDestination(MAP_GROUP(ROUTE2),MAP_NUM(ROUTE2),1,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_LetsGettheBandBackTogether_Before()
{
    ...
    SetWarpDestination(MAP_GROUP(ARANTRAZ_MESS_HALL),MAP_NUM(ARANTRAZ_MESS_HALL), 0, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_MaskOff_F()
{
    ...
    SetWarpDestination(MAP_GROUP(MERMEREZA_CITY_CONSULTING),MAP_NUM(MERMEREZA_CITY_CONSULTING),NO_WARP_ID,4,5);
}
...
void FlagsVarWarp_MaskOff_I()
{
    ...
    SetWarpDestination(MAP_GROUP(TORA_TOWN_RAMEN),MAP_NUM(TORA_TOWN_RAMEN),NO_WARP_ID,9,6);
}
...
void FlagsVarWarp_MaskOff_G()
{
    ...
    SetWarpDestination(MAP_GROUP(CAPHE_CITY_LIBRARY),MAP_NUM(CAPHE_CITY_LIBRARY),NO_WARP_ID,4,4);
}
...
void FlagsVarWarp_MaskOff_Alcmene()
{
    ...
    SetWarpDestination(MAP_GROUP(WISHAAST_LAKE),MAP_NUM(WISHAAST_LAKE),NO_WARP_ID,22,26);
}
...
void FlagsVarWarp_LockedOut()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND_KAI),MAP_NUM(HALAI_ISLAND_KAI),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_WarehouseRave()
{
    ...
    SetWarpDestination(MAP_GROUP(CURENO_PORT),MAP_NUM(CURENO_PORT),4,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_Persuasivepassenger()
{
    ...
    SetWarpDestination(MAP_GROUP(ARRIBA_2F),MAP_NUM(ARRIBA_2F),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_Warehousewarfare()
{
    ...
    SetWarpDestination(MAP_GROUP(PRESTO_BARGE_3),MAP_NUM(PRESTO_BARGE_3),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_Earthquake_Inside()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND),MAP_NUM(HALAI_ISLAND),2,USE_WARP_ID,USE_WARP_ID);
...
void FlagsVarWarp_Earthquake_Outside()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND),MAP_NUM(HALAI_ISLAND),NO_WARP_ID,11,17);
}
...
void FlagsVarWarp_ThisIsntRandom_Discover()
{
    ...
    SetWarpDestination(MAP_GROUP(PARC),MAP_NUM(PARC),0,USE_WARP_ID,USE_WARP_ID);
}
...
void FlagsVarWarp_ThisIsntRandom_Mon1()
{
    ...
    SetWarpDestination(MAP_GROUP(PARC),MAP_NUM(PARC),NO_WARP_ID,4,26);
}
...
void FlagsVarWarp_ThisIsntRandom_Mon2()
{
    ...
    SetWarpDestination(MAP_GROUP(PARC),MAP_NUM(PARC),NO_WARP_ID,4,17);
}
...
void FlagsVarWarp_WaitEvenThen()
{
    ...
    SetWarpDestination(MAP_GROUP(HALAI_ISLAND),MAP_NUM(HALAI_ISLAND),NO_WARP_ID,32,13);
}
...
void FlagsVarWarp_LetsFinishThis()
{
    ...
    SetWarpDestination(MAP_GROUP(QIU_VILLAGE),MAP_NUM(QIU_VILLAGE),NO_WARP_ID,13,19);
}
...
void FlagsVarWarp_ImIn_Breakin()
{
    ...
    SetWarpDestination(MAP_GROUP(QIU_VILLAGE_RAMESH_HOUSE), MAP_NUM(QIU_VILLAGE_RAMESH_HOUSE), 1, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_ImIn_Postwarp()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LOBBY), MAP_NUM(SHARPRISE_SPIRE_LOBBY), 3, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_ImIn_Postrival()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_LEAGUEOPS), MAP_NUM(SHARPRISE_SPIRE_LEAGUEOPS), 1, USE_WARP_ID, USE_WARP_ID);
}
...
void FlagsVarWarp_YouCantStopMe_Lastplea()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_TOP),MAP_NUM(SHARPRISE_SPIRE_TOP),NO_WARP_ID,6,7);
}
...
void FlagsVarWarp_YouCantStopMe_Postbattle()
{
    ...
    SetWarpDestination(MAP_GROUP(SHARPRISE_SPIRE_TOP),MAP_NUM(SHARPRISE_SPIRE_TOP),NO_WARP_ID,15,6);
