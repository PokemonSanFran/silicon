...
void FlagsVarWarp_HaveYouSeenTheNews()
{
    ...
    FlagSet(TRAINER_FLAGS_START + TRAINER_ARMANDO_ROBOT_1);
    FlagSet(TRAINER_FLAGS_START + TRAINER_ARMANDO_ROBOT_2);
    FlagSet(TRAINER_FLAGS_START + TRAINER_ARMANDO_ROBOT_3);
    FlagSet(TRAINER_FLAGS_START + TRAINER_ARMANDO_ROBOT_4);
