...
{
    // Start silicon
    [REMATCH_FREETHEINNOCENTHIKERC] = REMATCH(TRAINER_QUEST_FREETHEINNOCENTHIKERC,TRAINER_QUEST_FREETHEINNOCENTHIKERC_2,TRAINER_QUEST_FREETHEINNOCENTHIKERC_2,TRAINER_QUEST_FREETHEINNOCENTHIKERC_2,TRAINER_QUEST_FREETHEINNOCENTHIKERC_2,MAP_ROUTE9),
    ...
    [REMATCH_TEACHTRAINERFISHD] = REMATCH(TRAINER_QUEST_TEACHTRAINERFISHD,TRAINER_QUEST_TEACHTRAINERFISHD_2,TRAINER_QUEST_TEACHTRAINERFISH_2,TRAINER_QUEST_TEACHTRAINERFISH_2,TRAINER_QUEST_TEACHTRAINERFISH_2,MAP_WAJABI_LAKE),
...
static void CB2_EndWildBattle(void)
{
    ...
    {
        ResetDefeatedCresaltaVista(); // siliconQuests
...
static void DoFogBattle(bool32 isDouble)
{
    ...
    SetMonData(&gParties[B_TRAINER_OPPONENT_A][0], MON_DATA_NICKNAME, GetSpeciesName(fogMon));
    IncrementGameStat(GAME_STAT_TOTAL_BATTLES);
    IncrementGameStat(GAME_STAT_WILD_BATTLES);
    IncrementDailyWildBattles();
    TryUpdateGymLeaderRematchFromWild();
