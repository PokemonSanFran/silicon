...
void StartMassOutbreak(void)
{
    ...
    //gSaveBlock1Ptr->outbreakUnused1 = show->massOutbreak.unused1; // siliconMerge
    //gSaveBlock1Ptr->outbreakUnused2 = show->massOutbreak.unused2; // siliconMerge
    ...
    //gSaveBlock1Ptr->outbreakUnused3 = show->massOutbreak.unused3; // siliconMerge
...
void EndMassOutbreak(void)
{
    ...
    //gSaveBlock1Ptr->outbreakUnused1 = 0; // siliconMerge
    //gSaveBlock1Ptr->outbreakUnused2 = 0; // siliconMerge
    ...
    //gSaveBlock1Ptr->outbreakUnused3 = 0; // siliconMerge
