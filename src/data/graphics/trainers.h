...
const struct TrainerBacksprite gTrainerBacksprites[] =
{
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_DIMU, 5, gTrainerBackPic_Dimu, gTrainerBackPicPalette_Dimu, sBackAnims_Kanto),
    ...
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SHINZO, 5, gTrainerBackPic_Shinzo, gTrainerBackPicPalette_Shinzo, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_M1, 5, gTrainerBackPic_SiliconPlayerM1, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_M2, 5, gTrainerBackPic_SiliconPlayerM2, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_M3, 5, gTrainerBackPic_SiliconPlayerM3, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_N1, 5, gTrainerBackPic_SiliconPlayerN1, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_N2, 5, gTrainerBackPic_SiliconPlayerN2, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_N3, 5, gTrainerBackPic_SiliconPlayerN3, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_F1, 5, gTrainerBackPic_SiliconPlayerF1, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_F2, 5, gTrainerBackPic_SiliconPlayerF2, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    TRAINER_BACK_SPRITE(TRAINER_BACK_PIC_SILICON_PLAYER_F3, 5, gTrainerBackPic_SiliconPlayerF3, gTrainerBackPicPalette_SiliconPlayerM1, sBackAnims_Kanto),
    // End silicon
};
