...
static const u8 sGenericMulchDesc[]   = _("A fertilizer that\n"
        ...
        "local soil.");
// Start siliconMerge
static const u8 sInfiniteSprayRepelDesc[] = _(
        "This device\n"
        "repels wild\n"
        "Pokémon.");

static const u8 sUrshifuiteDesc[]     = _("This stone enables\n"
        "Urshifu to Mega\n"
        "Evolve in battle.");
// End siliconMerge
const struct Item gItemsInfo[] =
{
    ...
    //#include "data/siliconMachines.h"
    ...
    [ITEM_TM150] =
{
    ...
    .type = ITEM_USE_PARTY_MENU,
    .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    .secondaryId = MOVE_CHILLY_RECEPTION,
},
    ...
    [ITEM_TM210] =
{
    ...
    .type = ITEM_USE_PARTY_MENU,
    .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    .secondaryId = MOVE_LAST_RESPECTS,
},
    ...
    [ITEM_TM260] =
{
    ...
    .type = ITEM_USE_PARTY_MENU,
    .fieldUseFunc = ItemUseOutOfBattle_TMHM,
    .secondaryId = MOVE_PARABOLIC_CHARGE,
},
