...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_HOOTHOOT] =
    {
        ...
        .residoDexNum = RESIDO_DEX_HOOTHOOT,
        .categoryName = _("Owl"),
        .height = 7,
        .weight = 212,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .residoDexNum = RESIDO_DEX_NOCTOWL,
        .categoryName = _("Owl"),
        .height = 16,
        .weight = 408,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SPINARAK] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SPINARAK,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .residoDexNum = RESIDO_DEX_ARIADOS,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_TOGEPI] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TOGEPI,
    ...
    [SPECIES_TOGETIC] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TOGETIC,
    ...
    [SPECIES_TOGEKISS] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TOGEKISS,
    ...
    [SPECIES_MAREEP] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MAREEP,
        .categoryName = _("Wool"),
        .height = 6,
        .weight = 78,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_FLAAFFY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_FLAAFFY,
        .categoryName = _("Wool"),
        .height = 8,
        .weight = 133,
        .description = COMPOUND_STRING(
...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 85 : 75)
    ...
    [SPECIES_AMPHAROS] =
    {
        ...
        .residoDexNum = RESIDO_DEX_AMPHAROS,
        .categoryName = _("Light"),
        .height = 14,
        .weight = 615,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MURKROW,
    ...
    [SPECIES_HONCHKROW] =
    {
        ...
        .residoDexNum = RESIDO_DEX_HONCHKROW,
    ...
    [SPECIES_MISDREAVUS] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MISDREAVUS,
    ...
    [SPECIES_MISMAGIUS] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MISMAGIUS,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .residoDexNum = RESIDO_DEX_GIRAFARIG,
    ...
    [SPECIES_FARIGIRAF] =
    {
        ...
        .residoDexNum = RESIDO_DEX_FARIGIRAF,
        .categoryName = _("Long Neck"),
        .height = 32,
        .weight = 1600,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_GLIGAR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_GLIGAR,
    ...
    [SPECIES_GLISCOR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_GLISCOR,
    ...
    [SPECIES_SNUBBULL] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SNUBBULL,
    ...
    [SPECIES_GRANBULL] =
    {
        ...
        .residoDexNum = RESIDO_DEX_GRANBULL,
        .categoryName = _("Fairy"),
        .height = 14,
        .weight = 487,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SHUCKLE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SHUCKLE,
        .categoryName = _("Mold"),
        .height = 6,
        .weight = 205,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TEDDIURSA] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TEDDIURSA,
    ...
    [SPECIES_URSARING] =
    {
        ...
        .residoDexNum = RESIDO_DEX_URSARING,
    ...
    [SPECIES_URSALUNA] =
    {
        ...
        .residoDexNum = RESIDO_DEX_URSALUNA,
        .categoryName = _("Peat"),
        .height = 24,
        .weight = 2900,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SWINUB] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SWINUB,
        .categoryName = _("Pig"),
        .height = 4,
        .weight = 65,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PILOSWINE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_PILOSWINE,
    ...
    [SPECIES_MAMOSWINE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MAMOSWINE,
...
#define CORSOLA_DEFENSES (P_UPDATED_STATS >= GEN_7 ? 95 : 85)
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .residoDexNum = RESIDO_DEX_REMORAID,
        .categoryName = _("Jet"),
        .height = 6,
        .weight = 120,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_OCTILLERY,
        .categoryName = _("Jet"),
        .height = 9,
        .weight = 285,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_PHANPY,
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .residoDexNum = RESIDO_DEX_DONPHAN,
    ...
    [SPECIES_STANTLER] =
    {
        ...
        .residoDexNum = RESIDO_DEX_STANTLER,
    ...
    [SPECIES_WYRDEER] =
    {
        ...
        .residoDexNum = RESIDO_DEX_WYRDEER,
        .categoryName = _("Big Horn"),
        .height = 18,
        .weight = 951,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_SMEARGLE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SMEARGLE,
    ...
    [SPECIES_MILTANK] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MILTANK,
    ...
    [SPECIES_LARVITAR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_LARVITAR,
    ...
    [SPECIES_PUPITAR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_PUPITAR,
    ...
    [SPECIES_TYRANITAR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TYRANITAR,
        .categoryName = _("Armor"),
        .height = 20,
        .weight = 2020,
        .description = COMPOUND_STRING(
