...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_NYMBLE,
    ...
    [SPECIES_MASCHIFF] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MASCHIFF,
    ...
    [SPECIES_MABOSSTIFF] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MABOSSTIFF,
        .categoryName = _("Boss"),
        .height = 11,
        .weight = 610,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .residoDexNum = RESIDO_DEX_BOMBIRDIER,
