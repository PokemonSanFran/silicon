...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
    ...
    [SPECIES_CLEFFA] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CLEFFA,
    ...
    [SPECIES_CLEFAIRY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CLEFAIRY,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CLEFABLE,
        .categoryName = _("Fairy"),
        .height = 13,
        .weight = 400,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_PRIMEAPE] =
    {
        ...
        // Start siliconTests
    #if TESTING
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_ANNIHILAPE, CONDITIONS({IF_USED_MOVE_X_TIMES, MOVE_RAGE_FIST, 10})}),
    #else
        // End siliconTests
...
// End siliconMerge
    ...
    [SPECIES_MIME_JR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MIME_JR,
        .categoryName = _("Mime"),
        .height = 6,
        .weight = 130,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_MR_MIME] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MR_MIME,
