...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .residoDexNum = RESIDO_DEX_FENNEKIN,
        .categoryName = _("Fox"),
        .height = 4,
        .weight = 94,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_BRAIXEN] =
    {
        ...
        .residoDexNum = RESIDO_DEX_BRAIXEN,
        .categoryName = _("Fox"),
        .height = 10,
        .weight = 145,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_DELPHOX] =
    {
        ...
        .residoDexNum = RESIDO_DEX_DELPHOX,
        .categoryName = _("Fox"),
        .height = 15,
        .weight = 390,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_BUNNELBY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_BUNNELBY,
    ...
    [SPECIES_DIGGERSBY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_DIGGERSBY,
        .categoryName = _("Digging"),
        .height = 10,
        .weight = 424,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .residoDexNum = RESIDO_DEX_FLETCHLING,
    ...
    [SPECIES_FLETCHINDER] =
    {
        ...
        .residoDexNum = RESIDO_DEX_FLETCHINDER,
    ...
    [SPECIES_TALONFLAME] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TALONFLAME,
...
#define SCATTERBUG_SPECIES_INFO(evolution)                                                  \
    {                                                                                       \
        ...
        .residoDexNum = RESIDO_DEX_SCATTERBUG,                                       \
...
#define SPEWPA_SPECIES_INFO(evolution)                                          \
    {                                                                           \
        ...
        .residoDexNum = RESIDO_DEX_SPEWPA,                                       \
        .categoryName = _("Scatterdust"),                                       \
        .height = 3,                                                            \
        .weight = 84,                                                           \
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
        ...
        .residoDexNum = RESIDO_DEX_VIVILLON,                                       \
...
#define FLABEBE_MISC_INFO(Form, FORM, iconPal)                                  \
        ...
        .residoDexNum = RESIDO_DEX_FLABEBE,                                       \
...
#define FLOETTE_MISC_INFO(form, FORM, iconPal)                                  \
        ...
        .residoDexNum = RESIDO_DEX_FLOETTE,                                       \
        .categoryName = _("Single Bloom"),                                      \
        .height = 2,                                                            \
        .weight = 9,                                                            \
        .pokemonScale = 682,                                                    \
...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
        ...
        .residoDexNum = RESIDO_DEX_FLORGES,                                       \
    ...
    [SPECIES_PANCHAM] =
    {
        ...
        .residoDexNum = RESIDO_DEX_PANCHAM,
    ...
    [SPECIES_PANGORO] =
    {
        ...
        .residoDexNum = RESIDO_DEX_PANGORO,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_HONEDGE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_HONEDGE,
    ...
    [SPECIES_DOUBLADE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_DOUBLADE,
        .categoryName = _("Sword"),
        .height = 8,
        .weight = 45,
        .description = COMPOUND_STRING(
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_AEGISLASH_SHIELD] =
    {
        ...
        .residoDexNum = RESIDO_DEX_AEGISLASH,
    ...
    [SPECIES_SWIRLIX] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SWIRLIX,
    ...
    [SPECIES_SLURPUFF] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SLURPUFF,
    ...
    [SPECIES_SKRELP] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SKRELP,
    ...
    [SPECIES_DRAGALGE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_DRAGALGE,
        .categoryName = _("Mock Kelp"),
        .height = 18,
        .weight = 815,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_TYRUNT] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TYRUNT,
    ...
    [SPECIES_TYRANTRUM] =
    {
        ...
        .residoDexNum = RESIDO_DEX_TYRANTRUM,
    ...
    [SPECIES_HAWLUCHA] =
    {
        ...
        .residoDexNum = RESIDO_DEX_HAWLUCHA,
    ...
    [SPECIES_KLEFKI] =
    {
        ...
        .residoDexNum = RESIDO_DEX_KLEFKI,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .residoDexNum = RESIDO_DEX_NOIBAT,
    ...
    [SPECIES_NOIVERN] =
    {
        ...
        .residoDexNum = RESIDO_DEX_NOIVERN,
        .categoryName = _("Sound Wave"),
        .height = 15,
        .weight = 850,
        .description = COMPOUND_STRING(
