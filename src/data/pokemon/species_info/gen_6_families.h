...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_MALAMAR] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MALAMAR,
    ...
    [SPECIES_SLIGGOO] =
    {
        ...
        .residoDexNum = RESIDO_DEX_SLIGGOO,
        .categoryName = _("Soft Tissue"),
        .height = 8,
        .weight = 175,
        .description = COMPOUND_STRING(
    ...
    [SPECIES_GOODRA] =
    {
        ...
        .residoDexNum = RESIDO_DEX_GOODRA,
