...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_CRABRAWLER] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CRABRAWLER,
    ...
    [SPECIES_CRABOMINABLE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CRABOMINABLE,
    ...
    [SPECIES_CUTIEFLY] =
    {
        ...
        .residoDexNum = RESIDO_DEX_CUTIEFLY,
    ...
    [SPECIES_RIBOMBEE] =
    {
        ...
        .residoDexNum = RESIDO_DEX_RIBOMBEE,
        .categoryName = _("Bee Fly"),
        .height = 2,
        .weight = 5,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal)          \
    ...
    [SPECIES_MIMIKYU_DISGUISED] =
    {
        ...
        .residoDexNum = RESIDO_DEX_MIMIKYU,
