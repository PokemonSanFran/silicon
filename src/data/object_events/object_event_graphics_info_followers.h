...
// Start siliconNewBalls
    POKEBALL_GFX_INFO(BOG),
    POKEBALL_GFX_INFO(ELECTRO),
    POKEBALL_GFX_INFO(FABLE),
    POKEBALL_GFX_INFO(JETSTREAM),
    POKEBALL_GFX_INFO(MINERAL),
    POKEBALL_GFX_INFO(PARADOX),
    POKEBALL_GFX_INFO(PSYCHE),
    POKEBALL_GFX_INFO(VITALITY),
// End siliconNewBalls
};
