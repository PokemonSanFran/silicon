const struct Zap gZaps[] =
{
    ...
    {
        .userId = 0,
        .content = COMPOUND_STRING("end of the line"),
        .isPrivate = FALSE,
        .criteria = 0,
        .quest = 0,
    ...
    [ZAP_STORY_EPILOGUE] =
    {
        ...
        .content = COMPOUND_STRING("We've got more work to do!\nLet's get at it."),
        .isPrivate = FALSE,
    ...
    {
        .userId = BUZZR_USER_SOCIETY,
        .content = COMPOUND_STRING("Even {PLAYER} has seen the light and is ready to grow stronger. Why haven't you?"),
        .isPrivate = FALSE,
    ...
    [ZAP_LUCREZIA_JOB] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasMetLucrezia,
        .quest = 0,
    ...
    [ZAP_ADAORA_TRUST] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterSorryAbout,
        .quest = 0,
    ...
    [ZAP_CHARLOTTE_TRASH] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterChallengeStart,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("2"),
    ...
    [ZAP_MEGACROSS_DEFENSE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasAllBadges,
        .quest = 0,
    ...
    [ZAP_SHARPRISE_FLOWN] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasFlownIn,
        .quest = 0,
    ...
    [ZAP_CHARLOTTE_PRODIGY] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasOneBadges,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("17"),
    ...
    [ZAP_POPIDORA_FREAKS] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasTwoBadges,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("16"),
        .likeCount = COMPOUND_STRING("1"),
    },
    [ZAP_GO_GOGGLES] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterDefeatedCharlotte,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("3"),
        .likeCount = COMPOUND_STRING("6"),
    },
    ...
    [ZAP_RAMESH_THANKS] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterWowYoureStrong,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("1"),
    ...
    [ZAP_CURENO_TIDE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterHowDoWeGetHome,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("6"),
        .likeCount = COMPOUND_STRING("1"),
    },
    ...
    [ZAP_PLAYER_POLICE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_FinishedHousingProtest,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
    ...
    [ZAP_GOLD_BREEDING] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_LearnedBreedingCenter,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("11"),
    ...
    [ZAP_ARANTRAZ_SCANDAL] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_VisitedArantraz,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("3"),
        .likeCount = COMPOUND_STRING("9"),
    },
    ...
    [ZAP_KEIYING_COMPETITIVE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterCapheRiot,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("4"),
    ...
    [ZAP_CHARLOTTE_PLAYER] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterBeachBattle,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("9"),
        .likeCount = COMPOUND_STRING("9"),
    },
    [ZAP_TALA_FIRED] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_AfterParade,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
        .likeCount = COMPOUND_STRING("0"),
    },
    ...
    [ZAP_TIDE_CONSTRUCTION] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_StrikeStarted,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("11"),
        .likeCount = COMPOUND_STRING("0"),
    },
    ...
    [ZAP_CHAMPIONSHIP_DELAYED] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_PostGarbodor,
        .quest = 0,
    ...
    [ZAP_HACK_PSA] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HackStarted,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("14"),
        .likeCount = COMPOUND_STRING("7.9K"),
    },
    [ZAP_SHAPRRISE_HACK] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HackStartedProgress,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("18K"),
    ...
    [ZAP_RAID_PSA] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_StartedNavalRaid,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("56"),
    ...
    [ZAP_CHAMPIONSHIP_START] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_TournamentStarted,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
        .likeCount = COMPOUND_STRING("2"),
    },
    [ZAP_POLICE_TIDE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_FinishedNavalRaid,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
        .likeCount = COMPOUND_STRING("5"),
    },
    ...
    [ZAP_SHARPRISE_FAN] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_GroupStagesComplete,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("2"),
        .likeCount = COMPOUND_STRING("7"),
    },
    ...
    [ZAP_FANTASY_LEAGUE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_BeforeFinals,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("4"),
    ...
    [ZAP_PLAYER_BAIYA] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_ZenzuBattle,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("2"),
        .likeCount = COMPOUND_STRING("9"),
    },
    [ZAP_HODOU_JOHNNY] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_FoundHodouLeader,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("5"),
        .likeCount = COMPOUND_STRING("0"),
    },
    [ZAP_ZENZU_MOVING] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_FinishedZenzu,
        .quest = 0,
    ...
    [ZAP_TRAINING_VIBE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_HasCompletedOneRestoration,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
        .likeCount = COMPOUND_STRING("1"),
    },
    [ZAP_ARANTRAZ_UNSETTLING] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_ArrivedSummonedArantraz,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("2"),
        .likeCount = COMPOUND_STRING("434"),
    },
    [ZAP_HODOU_FIGHT] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_StartedHowDisappointing,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("8"),
    ...
    [ZAP_POLICE_BRUTE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_StartedManhunt,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("2"),
        .likeCount = COMPOUND_STRING("7"),
        .shouldCorrupt = TRUE,
    ...
    [ZAP_TIDE_RIOTS] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_TwoTideTakedown,
        .quest = 0,
    ...
    [ZAP_PLAYER_RANCID] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_TideFinished,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("13"),
    ...
    [ZAP_CREEPY_LADY] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_GotWishTag,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("17"),
    ...
    [ZAP_TORGEOT_CHILLS] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_VisitedTorgeot,
        .quest = 0,
    ...
    [ZAP_SHARPRISE_BOYCOTT] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_MaskOffAssigned,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("51"),
        .likeCount = COMPOUND_STRING("7"),
    },
    ...
    [ZAP_E4_WATCH] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_SpeechComplete,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
    ...
    [ZAP_BAIYA_BUDDY] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_RaveComplete,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("1"),
    ...
    {
        .userId = BUZZR_USER_PLACEHOLDER,
        .content = COMPOUND_STRING("Shoutout to some of the locals who've been helping me and ma unload deliveries from the mart lately. Her back's giving out as many of y'all know. You's are the best! Resido, baby!"),
        .isPrivate = FALSE,
        .criteria = ZapCriteria_BodegaBurnout,
        .quest = 0,
    ...
    [ZAP_HALAI_NIGHTMARE] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_EarthquakeHappened,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("15"),
        .likeCount = COMPOUND_STRING("1"),
    },
    ...
    [ZAP_FIRST_PROTEST] =
    {
        ...
        .isPrivate = FALSE,
        .criteria = ZapCriteria_TowerRaidStarted,
        .quest = 0,
        .dislikeCount = COMPOUND_STRING("0"),
