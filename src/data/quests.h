...
const struct SideQuest sSideQuests[QUEST_COUNT] =
{
    ...
    {
        .name = COMPOUND_STRING("Ecosystem Impact Study"),
        .desc = COMPOUND_STRING("???"),
        .donedesc = COMPOUND_STRING("???"),
        .map = COMPOUND_STRING("???"),
        .sprite = OBJ_EVENT_GFX_DIMU,
        .spritetype = QUEST_SPRITE_TYPE_OBJECT,
        .subquests = NULL,
        .numSubquests = 0,
    },
    ...
    {
        .name = COMPOUND_STRING("Poisoned Lake Investigation"),
        .desc = COMPOUND_STRING("???"),
        .donedesc = COMPOUND_STRING("???"),
        .map = COMPOUND_STRING("???"),
        .sprite = OBJ_EVENT_GFX_DIMU,
