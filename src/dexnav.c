...
// static u8 GetEncounterLevelFromMapData(u16 species, enum EncounterType environment); // phenomenon
...
u8 GetEncounterLevelFromMapData(u16 species, enum EncounterType environment)
// End phenomenon
{
