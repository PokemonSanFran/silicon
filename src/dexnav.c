...
//static u8 GetEncounterLevelFromMapData(enum Species species, enum EncounterType environment); // phenomenon
...
u8 GetEncounterLevelFromMapData(enum Species species, enum EncounterType environment)
// End phenomenon
{
