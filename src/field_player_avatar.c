...
//static bool8 TryPushBoulder(s16, s16, enum Direction); //qol_field_moves
...
} sPlayerAvatarGfxToStateFlag[NUM_ALL_BODY_TYPES][5] =
// End playerCustom
{
        /*
    [MALE] =
...
*/
    [BODY_TYPE_M1] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_M2] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_M2_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M2_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M2_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M2_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M2_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_M3] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_M3_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M3_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M3_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M3_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M3_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_N1] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_N1_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N1_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N1_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N1_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N1_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_N2] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_N2_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N2_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N2_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N2_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_N2_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_N3] =
    {
    ...
    [BODY_TYPE_F2] =
    {
        {OBJ_EVENT_GFX_SILICON_PLAYER_F2_NORMAL,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_F2_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_F2_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_F2_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_F2_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [BODY_TYPE_F3] =
    {
    ...
    [BODY_TYPE_CHAMPION] =
    {
        {OBJ_EVENT_GFX_SHINJI,     PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_MACH_BIKE,  PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_ACRO_BIKE,  PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_SURFING,    PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_SILICON_PLAYER_M1_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
...
static bool8 DoForcedMovement(enum Direction direction, void (*moveFunc)(enum Direction))
{
    ...
    enum Collision collision = CheckForPlayerAvatarCollision(direction); // qol_field_moves
...
// Start playerCustom
enum BodyTypes GetPlayerAvatarGenderByGraphicsId(u16 graphicsId)
{
    for (enum BodyTypes bodyType = 0; bodyType < NUM_ALL_BODY_TYPES; bodyType++)
        for (u32 state = 0; state < 5; state++)
            if (sPlayerAvatarGfxToStateFlag[bodyType][state].graphicsId == graphicsId)
                return bodyType;
