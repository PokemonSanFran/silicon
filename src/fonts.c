#include "global.h"
#include "constants/characters.h" // addCrimFont
...
// Start addCrimFont
// PSF TODO the height and width of each glyph needs to be adjusted, and Archie said he would do so
ALIGNED(4) const u16 gFontOutlineLatinGlyphs[] = INCBIN_U16("graphics/fonts/outline.latfont");
ALIGNED(4) const u8 gFontOutlineLatinGlyphWidths[] = {
    [CHAR_SPACE] = 3,
    [CHAR_A_GRAVE] = 6,
    [CHAR_A_ACUTE] = 6,
    [CHAR_A_CIRCUMFLEX] = 6,
