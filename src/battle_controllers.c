...
void BtlController_EmitMidBattleEvo(enum BattlerId battler, u32 bufferId, u32 partyId, u32 species)
{
...
#if TESTING
        if ((gTestRunnerHeadless || *stringId == STRINGID_CELEBRATEMESSAGE) && !gSiliconTestVariables.checkFontGraphics && !gSiliconTestVariables.checkPrintSpeed)
#else
