...
static void GiveDebugStarter(void)
{
    ...
    ScriptGiveMonParameterized(0,PARTY_SIZE,SPECIES_BIBAREL,22,ITEM_NONE,ITEM_CHERISH_BALL,NATURE_BOLD,2,MON_FEMALE,evs,ivs,moves[2],TRUE,0,NUMBER_OF_MON_TYPES);
