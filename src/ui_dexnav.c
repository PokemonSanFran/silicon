    ...
    {
        {
            ...
            .tag = DEXNAV_SPRITETAG_LOADING,
        },
        {
            .data = (const u16[])INCBIN_U16("graphics/ui_menus/dexnav/loading.gbapal"),
            .tag = DEXNAV_PALTAG_LOADING,
        },
    },
...
static bool8 Dexnav_IsCurrentModeWithinProximity(void)
{
    return (Dexnav_GetMode() == DEXNAV_MODE_SCAN_INSIDE);
}
...
{
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_0,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_1,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_2,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_3,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_4,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_5,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_6,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_RED_FRAME_7,8),
...
{
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_0,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_1,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_2,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_3,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_4,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_5,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_6,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_STAT_INDICATOR_STAT_BLUE_FRAME_7,8),
...
static const union AnimCmd sAnim_LoadingPostion0[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_1,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_2,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_3,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_4,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_5,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_6,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_8,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_9,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_10,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_11,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_0,8),
    ANIMCMD_JUMP(0),
};

static const union AnimCmd sAnim_LoadingPostion1[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_2,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_3,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_4,8),
...
static const union AnimCmd sAnim_LoadingPostion2[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_3,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_4,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_5,8),
...
static const union AnimCmd sAnim_LoadingPostion3[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_4,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_5,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_6,8),
...
static const union AnimCmd sAnim_LoadingPostion4[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_5,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_6,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_7,8),
...
static const union AnimCmd sAnim_LoadingPostion5[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_6,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_8,8),
...
static const union AnimCmd sAnim_LoadingPostion6[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_7,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_8,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_9,8),
...
static const union AnimCmd sAnim_LoadingPostion7[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_8,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_9,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_10,8),
...
static const union AnimCmd sAnim_LoadingPostion8[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_9,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_10,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_11,8),
...
static const union AnimCmd sAnim_LoadingPostion9[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_10,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_11,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_0,8),
...
static const union AnimCmd sAnim_LoadingPostion10[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_11,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_0,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_1,8),
...
static const union AnimCmd sAnim_LoadingPostion11[] =
{
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_0,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_1,8),
    ANIMCMD_FRAME(DEXNAV_LOADING_FRAME_2,8),
...
static const union AnimCmd * const sSpriteAnimTable_Loading[] =
{
    sAnim_LoadingPostion0,
    sAnim_LoadingPostion1,
    sAnim_LoadingPostion2,
    sAnim_LoadingPostion3,
    sAnim_LoadingPostion4,
    sAnim_LoadingPostion5,
    sAnim_LoadingPostion6,
    sAnim_LoadingPostion7,
    sAnim_LoadingPostion8,
    sAnim_LoadingPostion9,
    sAnim_LoadingPostion10,
    sAnim_LoadingPostion11,
};
...
static void Dexnav_DisplayStatIndicator(u32 count, u32 position)
{
    ...
    bool32 isWithinProximity = Dexnav_IsCurrentModeWithinProximity();
    u32 tileTag = isWithinProximity ? DEXNAV_SPRITETAG_IV : DEXNAV_SPRITETAG_LOADING;
    ...
    TempSpriteTemplate.callback = SpriteCallbackDummy;
    TempSpriteTemplate.paletteTag = paletteTag;
    TempSpriteTemplate.anims = anims;
...
u32 Dexnav_CalculateLevel(u32 species, enum EncounterType environment)
{
    ...
    if (insight > DEXNAV_MAX_INSIGHT)
        insight = DEXNAV_MAX_INSIGHT;

    u32 levelBonus = ((1 / DEXNAV_MAX_INSIGHT) * DEXNAV_MAX_LEVEL_BONUS_FROM_INSIGHT) * insight;
