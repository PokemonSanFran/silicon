...
#define SOUND_LIST_BGM \
    ...
    X(MUS_RG_TEACHY_TV_MENU) \
        X(MUS_PASCAL_ACCEPT_LETTER) \
    X(MUS_PASCAL_ALAMEDA) \
    X(MUS_PASCAL_ALAMEDA_POST_EARTHQUAKE) \
    X(MUS_PASCAL_BATTLE_ARCADE) \
    X(MUS_PASCAL_BATTLE_ARCHER) \
    X(MUS_PASCAL_BATTLE_FACTORY) \
    X(MUS_PASCAL_BATTLE_FINALS) \
    X(MUS_PASCAL_BATTLE_TOWER) \
    X(MUS_PASCAL_BERKELEY) \
    X(MUS_PASCAL_BERNALHILL1) \
    X(MUS_PASCAL_BERNALHILL) \
    X(MUS_PASCAL_CHASECENTER) \
    X(MUS_HODOU_CITY) \
    X(MUS_PASCAL_DOGPATCH) \
    X(MUS_PASCAL_ENCOUNTER_SOLICITOR) \
    X(MUS_PASCAL_FORT_POINT_GYM) \
    X(MUS_PASCAL_GLDGTEWILDS) \
    X(MUS_PASCAL_GOLDENGATE_PARK) \
    X(MUS_PASCAL_HAIGHTAHBURY_GYM) \
    X(MUS_PASCAL_HALL_OF_FAME) \
    X(MUS_PASCAL_HOW_DISSAPOINTING) \
    X(MUS_TORA_TOWN) \
    X(MUS_PASCAL_MARIN) \
    X(MUS_PASCAL_MASTER_DOJO) \
    X(MUS_PASCAL_MISSION) \
    X(MUS_PASCAL_PACIFICA) \
    X(MUS_PASCAL_POKEMON_CENTER) \
    X(MUS_PASCAL_ROSE_RAID) \
    X(MUS_PASCAL_ROUTE_13) \
    X(MUS_PASCAL_ROUTE_14) \
    X(MUS_PASCAL_ROUTE_17) \
    X(MUS_PASCAL_ROUTE_5) \
    X(MUS_PASCAL_ROUTE_62) \
    X(MUS_PASCAL_ROUTE_8) \
    X(MUS_PASCAL_ROUTE_9) \
    X(MUS_PASCAL_SALESFORCETOWERPARK) \
    X(MUS_PASCAL_SALESFORCETOWER_RAID) \
    X(MUS_PASCAL_SAVE) \
    X(MUS_PASCAL_SOMA) \
    X(MUS_PASCAL_SUNSET) \
    X(MUS_PASCAL_TREASURE_ISLAND) \
    X(MUS_PASCAL_TWIN_PEAKS) \
    X(MUS_PASCAL_VS_ELITE_FOUR) \
