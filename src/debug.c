...
static const struct DebugMenuOption sDebugMenu_Actions_PCBag_Fill[] =
{
    ...
    { COMPOUND_STRING("Fill Pocket Key Items"),     DebugAction_PCBag_Fill_PocketKeyItems },
        // Start inventory
    { COMPOUND_STRING("Fill Pocket Medicine"),      DebugAction_PCBag_Fill_PocketMedicine},
    { COMPOUND_STRING("Fill Pocket Battle Items"),  DebugAction_PCBag_Fill_PocketBattle_Items},
    { COMPOUND_STRING("Fill Pocket Powerup"),       DebugAction_PCBag_Fill_PocketPowerup},
    { COMPOUND_STRING("Fill Pocket Other"),         DebugAction_PCBag_Fill_PocketOther},
    { COMPOUND_STRING("Fill Pocket Treasure"),      DebugAction_PCBag_Fill_PocketTreasure},
    { COMPOUND_STRING("Fill Pocket Z-Crystals"),    DebugAction_PCBag_Fill_PocketZ_Crystals},
    { COMPOUND_STRING("Fill Pocket Mega Stones"),   DebugAction_PCBag_Fill_PocketMega_Stones},
        // End inventory
    { NULL }
};
...
static void DebugAction_Quest(u8 taskId)
{
    ...
    StringCopy(gStringVar2, gText_DigitIndicator[0]);
    ConvertIntToDecimalStringN(gStringVar3, 0, STR_CONV_MODE_LEADING_ZEROS, CountDigits(QUEST_COUNT));
...
static void DebugAction_Quest_SelectQuest(u8 taskId)
{
    if (JOY_NEW(DPAD_ANY))
    {
        ...
        StringCopyPadded(gStringVar1, gStringVar1, CHAR_SPACE, 15);
        ConvertIntToDecimalStringN(gStringVar3, gTasks[taskId].tInput, STR_CONV_MODE_LEADING_ZEROS, CountDigits(QUEST_COUNT));
        StringExpandPlaceholders(gStringVar4,COMPOUND_STRING("Quest ID: {STR_VAR_3}\n{STR_VAR_1}{CLEAR_TO 160}\n\n{STR_VAR_2}")); // siliconMerge
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        StringCopyPadded(gStringVar1, gStringVar1, CHAR_SPACE, 15);
        ConvertIntToDecimalStringN(gStringVar3, gTasks[taskId].tInput, STR_CONV_MODE_LEADING_ZEROS, CountDigits(MAX_QUEST_STATES));
...
#define SOUND_LIST_BGM              \
    ...
    X(MUS_ENCOUNTER_POLICE_OFFICER) \
    X(MUS_ENCOUNTER_CONSTRUCTION_WORKER_FIREFIGHTER_POSTAL_WORKER_NURSE_DOCTOR_RAIL) \
    X(MUS_ENCOUNTER_MARTIAL_ARTIST) \
    X(MUS_ENCOUNTER_CASUAL_DUDE) \
    X(MUS_ENCOUNTER_BACKPACKER_HIKER) \
    X(MUS_HALL_OF_FAME_SILICON) \
    X(MUS_PETAROSA_BOROUGH) \
    X(MUS_SHARPRISE_STADIUM) \
    X(MUS_PIOCA_BRIDGE) \
    X(MUS_POPIDORA_PIER) \
    ...
    X(MUS_ESPULEE_OUTSKIRTS_GYM) \
    X(MUS_FORT_YOBU_GYM) \
    X(MUS_HALAI_ISLAND_EARTHQUAKE) \
    X(MUS_HALERBA_CITY) \
    X(MUS_HALERBA_WILDS) \
    ...
    X(MUS_CHASILLA_GYM) \
    X(MUS_ENCOUNTER_BODYBUILDER_TRIATHLETE_SURFER_SCUBADIVER) \
