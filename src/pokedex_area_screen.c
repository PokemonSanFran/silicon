...
static void Task_HandlePokedexAreaScreenInput(u8 taskId)
{
    ...
    case 1:
        ...
        //         else if (JOY_NEW(DPAD_RIGHT) || (JOY_NEW(R_BUTTON) && gSaveBlock2Ptr->optionsButtonMode == OPTIONS_BUTTON_MODE_LR)) // siliconMerge
		else if (JOY_NEW(DPAD_RIGHT) || (JOY_NEW(R_BUTTON) && OptionsMenu_GetSavedOptions(GAME_SETTINGS,GAME_OPTIONS_BUTTON_MODE) == OPTIONS_BUTTON_MODE_LR)) // siliconMerge
        {
