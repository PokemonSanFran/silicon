...
const u8 gText_PlayersAdventure_Flavor7[] =_("Head to the SharpRise Stadium construction\nsite on Route2.");
...
const u8 gText_PlayersAdventure_Flavor9_B[] =_("Get Frank's journal from the\ndepths of LanjingTunnel and\nbring it to LeaverraForest.");
const u8 gText_PlayersAdventure_Flavor10[] =_("Complete all of Frank's challenges in\nLeaverraForest.");
const u8 gText_PlayersAdventure_HeadToSharpriseSpire[] =_("Go to the SharpRise Spire to help SharpRise Capital.");
...
const u8 gText_PlayersAdventure_Flavor13[] =_("Go the SharpRise Stadium and get ready for\nthe Championship!");
...
const u8 gText_PlayersAdventure_Flavor24[] =_("Head to the SharpRise Spire to talk to\nSharpRise Capital.");
...
const u8 gText_PlayersAdventure_Flavor27[] =_("Head to the SharpRise Spire!\nTheTide isn't going to get in the\nway of your dreams.");
...
const u8 gText_PlayersAdventure_Flavor29[] =_("Work with SharpRise Capital at the\nSharpRise Spire to take down\nTheTide once and for all.");
const u8 gText_PlayersAdventure_Flavor30[] =_("TheTide is finished. You've done it.");
const u8 gText_PlayersAdventure_Flavor31[] =_("Enter the SharpRise Stadium Arena for your\nexhibition battle!");
