...
const u8 gText_Quest_HowDisappointing_Desc[] = _("Shut down the The Tide project\nin HodouCity!");
...
const u8 gText_PlayersAdventure_Flavor17[] =_("Watch Baiya vs Charlotte from the Skybox.");
const u8 gText_PlayersAdventure_Flavor18[] =_("Go the Arena, and face Baiya for the\nChampionship!");
...
const u8 gText_PlayersAdventure_Flavor36[] =_("Which corporation should The Tide\ntackle first? Head to Arantraz to\nstart working on it!");
const u8 gText_PlayersAdventure_Flavor36A[] =_("Report your success to the Elite Four at Arantraz!");
const u8 gText_PlayersAdventure_Flavor37[] =_("Head back to Baiya's house in HalaiIsland\nand get a good night's sleep.");
