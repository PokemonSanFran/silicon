...
EWRAM_DATA bool8 gMidBattleEvo = FALSE; // midBattleEvolution
...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_LEADER] = { _("Gym Leader"), 25, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_ULTRA : BALL_POKE },
    // End silicon
    ...
    [TRAINER_CLASS_SHARPRISE_COO] = { _("SharpRise COO") },
    [TRAINER_CLASS_SHARPRISE_CEO] = { _("SharpRise CEO") },
    ...
    [TRAINER_CLASS_BAKER]               = {_("Baker") },
    [TRAINER_CLASS_BALLER]              = {_("Baller") },
    [TRAINER_CLASS_BARISTA]             = {_("Barista") },
    [TRAINER_CLASS_BELLHOP]             = {_("Bellhop") },
    [TRAINER_CLASS_BIKER]               = {_("Biker") },
    [TRAINER_CLASS_BIOHACKER]          = {_("Biohacker") },
    [TRAINER_CLASS_BODYBUILDER]         = {_("Bodybuilder") },
    [TRAINER_CLASS_BUSKER]              = {_("Busker") },
    [TRAINER_CLASS_CABBIE]              = {_("Cabbie") },
    [TRAINER_CLASS_CAMERAPERSON]        = {_("Cameraperson") },
    [TRAINER_CLASS_CASUAL_DUDE]         = {_("Casual Dude") },
    [TRAINER_CLASS_CONSTRUCTION_WORKER] = {_("Construction Worker") },
    ...
    [TRAINER_CLASS_DOGWALKER]           = {_("Dogwalker") },
    [TRAINER_CLASS_DRAG_PERFORMER]      = {_("Drag Performer") },
    [TRAINER_CLASS_FANCY_PERSON]        = {_("Fancy Person") },
    [TRAINER_CLASS_FIREFIGHTER]         = {_("Firefighter") },
    [TRAINER_CLASS_FISHER]              = {_("Fisher") },
    [TRAINER_CLASS_FOUNDER]             = {_("Founder") },
    [TRAINER_CLASS_GAMER]               = {_("Gamer") },
    [TRAINER_CLASS_GARDENER]            = {_("Gardener") },
    [TRAINER_CLASS_GRAFFITI_ARTIST]     = {_("Graffiti Artist") },
    [TRAINER_CLASS_HEIR]                = {_("Heir") },
    [TRAINER_CLASS_HIPPIE]              = {_("Hippie") },
    [TRAINER_CLASS_HOBBYIST]            = {_("Hobbyist") },
    [TRAINER_CLASS_HODLER]              = {_("HODLer") },
    [TRAINER_CLASS_HUSTLER]             = {_("Hustler") },
    [TRAINER_CLASS_INFIELDER]           = {_("Infielder") },
    [TRAINER_CLASS_INFLUENCER]          = {_("Influencer") },
    [TRAINER_CLASS_JANITOR]             = {_("Janitor") },
    [TRAINER_CLASS_JUGGLER]             = {_("Juggler") },
    [TRAINER_CLASS_LANDLORD]            = {_("Landlord") },
    [TRAINER_CLASS_LEATHER_DADDY]       = {_("Leather Daddy") },
    [TRAINER_CLASS_MARTIAL_ARTIST]      = {_("Martial Artist") },
    [TRAINER_CLASS_MEGACROSS_SECURITY]  = {_("Megacross Security") },
    [TRAINER_CLASS_NURSE]               = {_("Nurse") },
    [TRAINER_CLASS_OFFICE_WORKER]       = {_("Office Worker") },
    [TRAINER_CLASS_OWNER]               = {_("Owner") },
    [TRAINER_CLASS_PARENT]              = {_("Parent") },
    [TRAINER_CLASS_POLICE_OFFICER]      = {_("Police Officer") },
    [TRAINER_CLASS_POSTAL_WORKER]       = {_("Postal Worker") },
    [TRAINER_CLASS_PRODUCT_MANAGER]     = {_("Product Manager") },
    [TRAINER_CLASS_PUNK]                = {_("Punk") },
    [TRAINER_CLASS_RAIL_STAFF]          = {_("Rail Staff") },
    [TRAINER_CLASS_REPORTER]            = {_("Reporter") },
    [TRAINER_CLASS_ROBOT_PERFORMER]     = {_("Robot Performer") },
    [TRAINER_CLASS_SCHOOLKID]           = {_("Schoolkid") },
    [TRAINER_CLASS_SCIENTIST]           = {_("Scientist") },
    [TRAINER_CLASS_SCUBA_DIVER]         = {_("Scuba Diver") },
    [TRAINER_CLASS_SOLICITOR]           = {_("Solicitor") },
    [TRAINER_CLASS_STREET_ARTIST]       = {_("Street Artist") },
    [TRAINER_CLASS_STREET_VENDOR]       = {_("Street Vendor") },
    [TRAINER_CLASS_STUDENT]             = {_("Student") },
...
static void BattleStartClearSetData(void)
{
    ...
    for (i = 0; i < PARTY_SIZE; i++)
    {
        gBattleStruct->battlersItemIds[i][B_SIDE_PLAYER] = GetMonData(&gParties[B_TRAINER_PLAYER][i], MON_DATA_HELD_ITEM); // Battle Settings: Take Wild Items
        gBattleStruct->battlersItemIds[i][B_SIDE_OPPONENT] = GetMonData(&gParties[B_TRAINER_OPPONENT_A][i], MON_DATA_HELD_ITEM); // Battle Settings: Take Wild Items
        for (enum BattleTrainer trainer = B_TRAINER_PLAYER; trainer < MAX_BATTLE_TRAINERS; trainer++)
        {
...
#define UNPACK_STARTING_STATUS_TO_BATTLE(_enum, _fieldName, ...) gStartingStatuses._fieldName = (statusesOpponentA._fieldName || statusesOpponentB._fieldName || gStartingStatuses._fieldName);
            ...
            if ((gBattleTypeFlags & BATTLE_TYPE_TRAINER && !IsSpecialTrainer(TRAINER_BATTLE_PARAM.opponentA)) || (TESTING))
            {
        ...
        case STATE_WAIT_ACTION_CHOSEN: // Try to perform an action.
            if (!IsBattleControllerActiveOrPendingSyncAnywhere(battler))
            {
                ...
                case B_ACTION_USE_ITEM:
                    ...
                    if ((ShouldBattleRestrictionsApply(battler) && !IsAllowedToUseBag()) || IsFogBattle())
                    // End fogBattle
                    {
...
void CountDefeatedBackyard(void)
{
    ...
    for (i = 0;i < 6;i++)
    {
        s32 enemySpecies = GetMonData(&gParties[B_TRAINER_OPPONENT_A][i],MON_DATA_SPECIES);
...
static void HandleEndTurn_FinishBattle(void)
{
    if (gCurrentActionFuncId == B_ACTION_TRY_FINISH || gCurrentActionFuncId == B_ACTION_FINISHED)
    {
            ...
            for (enum BattleTrainer trainer = B_TRAINER_PLAYER; trainer < MAX_BATTLE_TRAINERS; trainer++)
            {
                ...
                for (u32 partySlot = 0; partySlot < PARTY_SIZE; partySlot++)
                {
                    ...
                    */
                    ...
                    {
                        HandleSetPokedexFlagFromMon(&party[partySlot], FLAG_SET_SEEN);
                        SpeciesData_SetSavedLastForm(GetMonData(&party[partySlot],MON_DATA_SPECIES));
                    }
                    // End pokedex
                }
            }
        ...
        for (u32 i = 0; i < PARTY_SIZE; i++)
        {
            ...
            // Start siliconMerge
            PerformPlayerFaintedMonOperations(&gParties[B_TRAINER_PLAYER][i]);
