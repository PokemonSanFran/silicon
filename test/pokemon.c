...
{
    ZeroPlayerPartyMons();
    OptionsMenu_SetSavedOptions(BATTLE_SETTINGS,BATTLE_OPTIONS_INDIVIDUAL_VALUES,BATTLE_OPTION_INDIVIDUAL_VALUES_ENABLED); // Battle Settings: Individual Values
    OptionsMenu_SetSavedOptions(BATTLE_SETTINGS,BATTLE_OPTIONS_EFFORT_VALUES,BATTLE_OPTION_EFFORT_VALUES_ENABLED); // Battle Settings: Effort Values
