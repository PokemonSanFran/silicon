...
WILD_BATTLE_TEST("Ball Animations: Show all Ball catch animations")
{
    ...
    PARAMETRIZE { throw = ITEM_MINERAL_BALL;}
    PARAMETRIZE { throw = ITEM_ELECTRO_BALL;}
    PARAMETRIZE { throw = ITEM_BOG_BALL;}
    PARAMETRIZE { throw = ITEM_JETSTREAM_BALL;}
    PARAMETRIZE { throw = ITEM_FABLE_BALL;}
    PARAMETRIZE { throw = ITEM_PARADOX_BALL;}
...
TO_DO_BATTLE_TEST("Poke Balls can't be thrown when WE_FLAG_NO_CATCHING is set")
